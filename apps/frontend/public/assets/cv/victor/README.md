...
This folder contains static CV-style media assets for the Victor PBNS/persona
experience. Components reference these files by public URL, so keep filenames stable
when updating the visual set.
...
```text
apps/frontend/public/assets/cv/victor/
|-- README.md
|-- famous-people/
|-- background-desktop.avif
|-- background-desktop.webp
|-- background-mobile.avif
|-- background-tablet.avif
|-- background.png
|-- opengraph-image.jpg
```
