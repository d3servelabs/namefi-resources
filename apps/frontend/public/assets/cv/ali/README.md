...
This folder contains static CV-style media assets for the Ali PBNS/persona experience.
Components reference these files by public URL, so keep filenames stable when updating
the visual set.
...
```text
apps/frontend/public/assets/cv/ali/
|-- README.md
|-- famous-people/
