# Arabic Frontend Messages

This folder contains Egyptian Arabic translations for frontend message
namespaces. File names match the namespace names used by `next-intl`.
