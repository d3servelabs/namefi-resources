...
import type { nftMarketplacesContract } from '@namefi-astra/common/contract/nft-marketplaces-contract';
...
type ContractBackedRecord = {
  ...
  nftMarketplaces: ContractRouter<typeof nftMarketplacesContract>;
