...
export function Header() {
    ...
    const authenticated = useMemo(() => privyAuthenticated && privyUser && userQuery.isSuccess && userQuery.data.privyUserId === privyUser?.id, [privyAuthenticated, privyUser, userQuery.isSuccess, userQuery?.data?.privyUserId]);
