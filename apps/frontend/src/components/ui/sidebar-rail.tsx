  ...
  return (
    <button
      ...
      className={cn(
        ...
        // position
        '[[data-side=left]_&]:left-[calc(var(--sidebar-width)-8px)]',
        '[[data-side=left][data-collapsible=icon][data-state=collapsed]_&]:left-[calc(var(--sidebar-width-icon)-8px)]',
        '[[data-side=right]_&]:right-[calc(var(--sidebar-width)-8px)]',
        '[[data-side=right][data-collapsible=icon][data-state=collapsed]_&]:right-[calc(var(--sidebar-width-icon)-8px)]',
