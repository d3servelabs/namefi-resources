...
const previewConfig: ConfigInput = {
  ...
  EMAIL_DREAM_DOMAIN_AWAITS_ORDER_LOOKBACK_DAYS: process.env
    ...
    : 30 / 86_400,
  EMAIL_CART_DOMAINS_POPULAR_ITEM_MIN_AGE_DAYS: process.env
    .EMAIL_CART_DOMAINS_POPULAR_ITEM_MIN_AGE_DAYS
    ? Number(process.env.EMAIL_CART_DOMAINS_POPULAR_ITEM_MIN_AGE_DAYS)
    : 30 / 86_400,
