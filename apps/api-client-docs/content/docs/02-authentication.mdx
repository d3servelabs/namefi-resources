...
If you want to prepare auth payloads without wiring a signer into the client, use the public [namefi-api-skills](https://github.com/d3servelabs/namefi-api-skills) helpers.
