...
import {
  InputGroup,
  InputGroupAddon,
} from '@namefi-astra/ui/components/shadcn/input-group';
...
function CommandInput({
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="bg-input/30 border-input/30 focus-within:border-ring focus-within:ring-ring/50 h-8! rounded-lg! shadow-none! focus-within:ring-[3px] *:data-[slot=input-group-addon]:pl-2!">
        <CommandPrimitive.Input
          data-slot="command-input"
          className={cn(
            'w-full bg-transparent text-popover-foreground text-sm outline-none placeholder:text-muted-foreground focus:outline-none focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50',
            className,
          )}
          {...props}
        />
