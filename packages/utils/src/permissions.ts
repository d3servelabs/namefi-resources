...
export enum Permission {
  ...
  READ_NAMEFI_FEED = 'NAMEFI_FEED;;READ',
  WRITE_NAMEFI_FEED = 'NAMEFI_FEED;;WRITE',
  ...
  READ_ANNOUNCEMENTS = 'ANNOUNCEMENTS;;READ',
  WRITE_ANNOUNCEMENTS = 'ANNOUNCEMENTS;;WRITE',

  READ_AI_CREDITS = 'AI_CREDITS;;READ',
  WRITE_AI_CREDITS = 'AI_CREDITS;;WRITE',
