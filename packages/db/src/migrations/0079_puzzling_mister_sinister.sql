CREATE TYPE "public"."email_campaign_send_status" AS ENUM('PENDING', 'SENT', 'FAILED');--> statement-breakpoint
...
CREATE INDEX "email_campaign_sends_user_id_idx" ON "email_campaign_sends" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "email_campaign_sends_campaign_period_idx" ON "email_campaign_sends" USING btree ("campaign_key","period_start");--> statement-breakpoint
CREATE INDEX "email_campaign_sends_status_idx" ON "email_campaign_sends" USING btree ("status");