...
-- Seed data for 0x.city campaign with source-specific limits
-- Single campaign with separate limits per source
INSERT INTO free_claim_campaign_limits (campaign_key, parent_domain, source, max_claims_per_user)
VALUES
  ('0xcity-promo-2025', '0x.city', 'UPVOTE', 1),   -- 1 claim max for upvotes
  ('0xcity-promo-2025', '0x.city', 'SHARE', 1)     -- 1 claim max for shares
ON CONFLICT (campaign_key, parent_domain, source) DO UPDATE SET 
