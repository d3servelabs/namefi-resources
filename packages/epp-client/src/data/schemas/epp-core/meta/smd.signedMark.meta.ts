...
export const SmdSignedMarkMeta: XmlMeta = {
  strategyId: 'fxp-v1',
  root: {
    qname: {
    ...
    fields: {
      ...
      'smd:issuerInfo': {
        kind: 'element',
        xmlName: 'smd:issuerInfo',
        namespace: 'urn:ietf:params:xml:ns:signedMark-1.0',
        cardinality: 'one',
        nodeMeta: {
          qname: {
            namespace: 'urn:ietf:params:xml:ns:signedMark-1.0',
            localName: 'issuerInfo',
          },
          fields: {
            issuerID: {
              kind: 'attribute',
      ...
      'smd:notBefore': {
        kind: 'element',
        xmlName: 'smd:notBefore',
        namespace: 'urn:ietf:params:xml:ns:signedMark-1.0',
        cardinality: 'one',
      },
      'smd:notAfter': {
        kind: 'element',
        xmlName: 'smd:notAfter',
        namespace: 'urn:ietf:params:xml:ns:signedMark-1.0',
        cardinality: 'one',
      },
      'mark:abstractMark': {
