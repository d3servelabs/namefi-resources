...
**.eth** 域名不是传统的顶级域 (TLD，互联网地址中最后一个点后面的域名后缀)，而是一个由 **[以太坊](/zh/glossary/ethereum/)名称服务 (ENS)** 提供支持的**基于区块链的命名系统**。与由 [ICANN](/zh/glossary/icann/) 管理的传统域名不同，`.eth` 域名是**去中心化的，作为 NFT 拥有，并存储在以太坊区块链上**。
...
*   **去中心化网站**——在 [IPFS](/zh/glossary/ipfs/) 和其他去中心化网络上托管抗审查网站。
