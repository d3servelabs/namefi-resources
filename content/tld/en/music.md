---
title: 'What Is the .music Domain? Eligibility & Who Can Register'
date: '2026-08-05'
language: 'en'
tags: ['tld']
...
editors: ['victor-zhou']
draft: false
description: 'The .music domain is a community-gated gTLD for the music industry, run by DotMusic Limited. Learn the id.MUSIC verification rules and whether you qualify.'
...
| Fact | Detail |
| --- | --- |
| TLD type | Generic top-level domain (new gTLD), Community-designated |
| Registry operator | DotMusic Limited |
| Registry agreement | Signed 4 May 2021 with ICANN (Base, Community/Spec 12, Non-Sponsored) |
| Delegated | 29 October 2021; general availability 8 October 2024 |
| IDN support | Varies by registrar — confirm before registering |
| DNSSEC | Supported |
| Registration restrictions | Community-restricted — must self-attest music-industry eligibility, then verify identity via id.MUSIC |
| Best for | Musicians, bands, labels, venues, and other verified music-industry participants |
...
.music's path to launch is unusually long even by new-gTLD standards:

- **A 2005 grassroots initiative.** According to the domain's [Wikipedia history](https://en.wikipedia.org/wiki/.music), Constantine Roussos began the ".MUSIC Initiative" in 2005 to build music-industry support for a dedicated top-level domain, years before ICANN's New gTLD Program opened applications.
- **One of the most contested strings in the program.** .music drew **eight competing applicants**, including Google's Charleston Road Registry, Amazon, Donuts, Far Further, and Radix — one of the most fought-over contention sets of the round.
- **Community Priority Evaluation win (2019).** DotMusic's application was built around ICANN's Community Priority Evaluation process, backed by organizations including the International Federation of the Phonographic Industry, the Recording Industry Association of America, and the Recording Academy. ICANN approved the application on **17 April 2019**.
- **Registry agreement and slow rollout (2021–2024).** The registry agreement was signed 4 May 2021. Per [ICANN's official .music launch phase record](https://newgtlds.icann.org/en/program-status/sunrise-claims-periods/music), the rollout ran a Qualified Launch Program, a Sunrise period (11 September–15 November 2023), and a Community Organization Phase Limited Registration Period (16 October 2023–10 September 2024) before general availability.
- **General availability, at last.** [Domain Incite reported](https://domainincite.com/30373-moment-of-truth-as-music-domains-finally-go-on-sale) that regular general availability began **8 October 2024** — "after a wait of over 15 years" from the original initiative.

## How people use .music

Real, specific niches where .music is designed to be used — and, under its own policy, largely restricted to:

- **Artists, bands, and songwriters** — official sites at their performing or legal name.
- **Record labels and music publishers** — catalog and roster sites.
- **Venues, promoters, and festivals** — event and booking pages.
- **Radio stations and recording studios** — institutional sites within the eligible community categories.
- **Music media and industry organizations** — press, trade, and advocacy sites tied to the music business.

**Who it's not ideal for:** anyone without a genuine, verifiable connection to the music industry. The registry explicitly prohibits buying, holding, or warehousing .music names for resale, particularly in bulk — this is not a namespace for generic domain investing.

## Notable sites using .music

Because .music only reached general availability in October 2024, it is too new to have accumulated widely recognized flagship sites the way long-established gTLDs have. Its registrant base by design skews toward verified music-industry participants — artists, labels, organizations — rather than general businesses. Real-world .music adoption is still in its early build-out phase.

## .music vs other domains

| Factor | .music | [.com](/en/tld/com) | [.live](/en/tld/live) |
| --- | --- | --- | --- |
| Registration restrictions | Community-restricted (verified music members only) | Open to all | Open to all |
| Sector signal | Very strong — explicitly music industry | None — fully generic | Moderate — streaming/events angle |
| Recognition & trust | New, but backed by major industry bodies | Highest, universal | Moderate |
| Typical price tier | Premium | Standard | Standard |
| Geo bias in SEO | None (generic) | None (generic) | None (generic) |

Pick .com for a music-adjacent business that doesn't want a registration gate; pick [.live](/en/tld/live) for concerts, streaming, or live-event branding without community verification; pick .music specifically when you can pass eligibility and want the credibility signal that comes from a domain the general public cannot simply buy.

## Why choose .music?

- **Built-in credibility.** Because registration requires verified community membership, a .music domain signals genuine industry standing in a way an open gTLD cannot.
- **Backed by major industry bodies.** The application that won the string was supported by organizations including IFPI, the RIAA, and the Recording Academy.
- **Purpose-built namespace.** Every eligible registrant is, by policy, actually part of the music industry — reducing the generic-domain noise found in open gTLDs.
- **Fresh availability.** Because general availability only began in October 2024, desirable names are still obtainable that would be long gone in an open namespace of similar age.
...
## .music pricing and value

.music sits at the premium end of the new-gTLD market, reflecting its community-gated model rather than any single figure: because supply is limited to verified music-industry registrants, **first-year and renewal pricing typically differ**, and standard names have historically launched above budget-gTLD pricing. The registry also reserves **premium names** for high-demand strings. Main cost drivers are string desirability, premium classification, and registrar margin — we list no figures here; check current rates at the point of purchase.
...
No. Google treats .music as a generic top-level domain with no geographic bias and no built-in ranking boost or penalty. Its community restriction affects who can register it, not how Google ranks it.
