---
title: "¿Qué es el dominio .africa y por qué elegirlo?"
date: '2025-12-10'
language: 'es'
tags: ['tld']
authors: ['namefiteam']
...
El dominio **.africa** es un Dominio de Nivel Superior Genérico (gTLD) diseñado específicamente para establecer una identidad digital clara y unificada para el continente africano. A diferencia de los dominios de código de país (ccTLD) como .za (Sudáfrica) o .ng (Nigeria), que se limitan a naciones específicas, .africa abarca toda la región, ofreciendo una plataforma para individuos y empresas que desean proyectar una presencia panafricana.

Lanzado al público general en 2017 y gestionado por [Registry Africa](https://registry.africa/), este dominio cuenta con el apoyo oficial de la **Unión Africana**. Su propósito es empoderar a la comunidad africana y global para compartir sus historias, productos y servicios bajo un mismo paraguas digital, fomentando el comercio electrónico y la integración tecnológica en uno de los mercados de más rápido crecimiento del mundo. Para más detalles técnicos sobre la delegación de este dominio, puedes consultar la información proporcionada por la [ICANN](https://www.icann.org/resources/pages/africa-2014-04-18-en).

## **Cómo se utiliza el dominio .africa**
...
## **Entidades notables que usan .africa**

Aunque es un TLD relativamente joven en comparación con los gigantes tradicionales, varias entidades de alto perfil han adoptado .africa para fortalecer su identidad digital:
...
## **Registra tu dominio .africa en Namefi**
...
[Registra tu dominio .africa en Namefi hoy mismo](https://namefi.io) y conecta tu marca con uno de los mercados más vibrantes del mundo.