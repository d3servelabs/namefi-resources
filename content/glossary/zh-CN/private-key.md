...
**私钥**（private key）是控制区块链账户的秘密数字——在大多数区块链上为 256 位——它生成用于授权账户所有交易的数字签名，绝不能脱离你的掌控。一旦丢失，你将永久失去资产；一旦泄露，任何人都可清空你的[钱包](/zh-CN/glossary/wallet/)。大多数用户不会直接接触原始私钥，而是通过[助记词](/zh-CN/glossary/seed-phrase/)——一种可确定性地还原私钥的可读词组——来保护它。与私钥对应的[公钥](/zh-CN/glossary/public-key/)由私钥派生而来，可安全地公开分享。
