...
relatedGlossary:
  ...
  - /zh-CN/glossary/leasing/
  - /zh-CN/glossary/dns/
  - /zh-CN/glossary/registrar/
  - /zh-CN/glossary/tokenize/
---

**自动化委托** 是指使用 [智能合约](/zh-CN/glossary/smart-contract/) 根据预定义规则或条件自动管理域名控制和委托。传统的域名委托需要手动干预才能更改名称服务器或 [DNS](/zh-CN/glossary/dns/) 设置。借助 [代币化](/zh-CN/glossary/tokenize/) 域名，[智能合约](/zh-CN/glossary/smart-contract/) 可以根据支付状态、基于时间的条件或治理决策等因素自动委托控制权。例如，如果租赁付款停止，一个 [租赁](/zh-CN/glossary/leasing/) 域名可以自动将控制权归还给所有者，或者一个 [DAO](/zh-CN/glossary/dao/) 拥有的域名可以根据社区投票自动更新其配置。这种自动化减少了手动开销，消除了人为错误，并实现了复杂的域名管理策略，这些策略无需中介即可可靠执行。