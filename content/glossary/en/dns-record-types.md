...
**DNS record types** define the kind of data stored in a [DNS](/en/glossary/dns/) resource record. The type tells a resolver how to interpret the answer; one domain can have different records for its website, email, and other services. [1](https://datatracker.ietf.org/doc/html/rfc1035#section-3.3)
...
A, CNAME, MX, and TXT are defined in RFC 1035. AAAA is defined in RFC 3596. [1](https://datatracker.ietf.org/doc/html/rfc1035#section-3.3) [2](https://datatracker.ietf.org/doc/html/rfc3596#section-2)
...
- **1.** IETF — [RFC 1035, standard record types](https://datatracker.ietf.org/doc/html/rfc1035#section-3.3) and [A records](https://datatracker.ietf.org/doc/html/rfc1035#section-3.4.1) — fetched 2026-09-15.
- **2.** IETF — [RFC 3596, AAAA records](https://datatracker.ietf.org/doc/html/rfc3596#section-2) — fetched 2026-09-15.
