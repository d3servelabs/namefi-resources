...
**ICANN (Internet Corporation for Assigned Names and Numbers)**, también conocida como la **Corporación de Internet para la Asignación de Nombres y Números**, es una organización sin fines de lucro con múltiples partes interesadas, constituida bajo la legislación de California en 1998. Es responsable de coordinar las políticas técnicas y las bases de datos que permiten que la internet global funcione como una red única y unificada. Concretamente, ICANN gestiona la asignación de [direcciones IP](/es/glossary/ip-address/), la asignación de nombres [DNS](/es/glossary/dns/) y la distribución de identificadores de protocolo — tareas conocidas colectivamente como las [funciones IANA](/es/glossary/iana/). Sin esta coordinación, el [DNS](/es/glossary/dns/) global se fragmentaría, haciendo que las direcciones web fueran irresolubles entre redes.

## Qué hace ICANN

El mandato de ICANN abarca tres áreas principales:

1. **Coordinación del sistema de nombres de dominio.** ICANN supervisa el espacio de nombres [DNS](/es/glossary/dns/) jerárquico, publicando y manteniendo el archivo de la [zona raíz](/es/glossary/root-zone/) — la lista autoritativa de todos los dominios de nivel superior ([gTLD](/es/glossary/gtld/)s y TLDs de código de país). Los cambios en la zona raíz solo entran en vigor tras la autorización de ICANN.

2. **Asignación de direcciones IP.** ICANN delega grandes bloques de espacio de direcciones IP a los cinco Registros Regionales de Internet (RIR), que a su vez subasignan direcciones a los ISP y organizaciones. Esta delegación se administra a través de las [funciones IANA](/es/glossary/iana/).
...
Además, ICANN establece la política para la acreditación de [registradores](/es/glossary/registrar/) de dominios y la operación de [registros](/es/glossary/registry/) de dominios, gestiona mecanismos de resolución de disputas y convoca a la comunidad global de internet para desarrollar políticas basadas en el consenso.
...
Durante la mayor parte de la era comercial de internet, el espacio de nombres de dominio de nivel superior genérico estaba muy restringido — dominado por cadenas heredadas como `.com`, `.net`, `.org`, `.gov`, `.edu` y `.mil`. ICANN lanzó su **Programa de Nuevos gTLD** en 2012, que por primera vez permitió a cualquier organización solicitar la operación de un nuevo [gTLD](/es/glossary/gtld/) — desde `.shop` y `.app` hasta `.nyc` y `.bank`. La primera ronda recibió 1.930 solicitudes; para 2014 ICANN había comenzado a delegar cientos de nuevas cadenas.

El programa de [nuevos gTLD](/es/glossary/new-gtld/)s cambió fundamentalmente el panorama de los dominios, aumentando el número de TLDs de aproximadamente 22 cadenas genéricas a más de 1.200 a mediados de la década de 2020. Una segunda ronda de solicitudes se abrió en 2026, atrayendo nuevamente a cientos de solicitantes de registros, marcas y comunidades geográficas. El programa está regulado por el Manual del Solicitante de ICANN y requiere que los solicitantes exitosos suscriban un Acuerdo de Registro con ICANN, paguen una cuota anual y cumplan con obligaciones técnicas y financieras.

## Acreditación de registradores (el RAA)

ICANN no vende nombres de dominio directamente al público. En cambio, acredita a empresas — denominadas [registradores acreditados](/es/glossary/accredited-registrar/) — para registrar nombres de dominio en nombre de los usuarios finales. Para convertirse en [registrador](/es/glossary/registrar/) acreditado por ICANN, una organización debe firmar el **Acuerdo de Acreditación de Registrador (RAA)**, pagar una cuota de acreditación y cumplir obligaciones técnicas, financieras y de protección al consumidor en curso ([Acreditación de Registradores de ICANN](https://www.icann.org/resources/pages/registrars-0d-2012-02-25-en)).
...
Los sistemas de nomenclatura alternativos — como el Ethereum Name Service (ENS), Handshake y Unstoppable Domains — operan fuera de la [zona raíz](/es/glossary/root-zone/) administrada por ICANN. Estos sistemas utilizan infraestructura blockchain para emitir nombres que no son reconocidos por los resolutores DNS estándar, lo que significa que requieren extensiones de navegador personalizadas o resolutores especiales para funcionar. ICANN no reconoce ni administra estos espacios de nombres, y los nombres registrados en ellos no tienen derechos ni protecciones bajo los marcos de resolución de disputas de ICANN como la [UDRP](/es/glossary/udrp/). Si y cómo estos espacios de nombres paralelos interactuarán eventualmente con el DNS gobernado por ICANN sigue siendo una pregunta abierta en los debates sobre gobernanza de internet.
