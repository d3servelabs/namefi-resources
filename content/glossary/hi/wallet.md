...
relatedGlossary:
  ...
  - /hi/glossary/web3/
  - /hi/glossary/hardware-wallet/
  - /hi/glossary/cryptographic-security/
  - /hi/glossary/blockchain/
---

क्रिप्टो संदर्भ में, एक **वॉलेट** एक डिजिटल टूल है जो प्राइवेट की (private keys) को स्टोर करता है और यूज़र्स को उनके [ब्लॉकचेन](/hi/glossary/blockchain/)-आधारित एसेट्स को मैनेज करने की अनुमति देता है। पारंपरिक वॉलेट के विपरीत जो भौतिक मुद्रा रखते हैं, क्रिप्टो वॉलेट [क्रिप्टोग्राफिक सुरक्षा](/hi/glossary/cryptographic-security/) की (keys) रखते हैं जो क्रिप्टोकरेंसी और [NFTs](/hi/glossary/nft/) जैसे डिजिटल एसेट्स के स्वामित्व को साबित करते हैं। जब आप Namefi के साथ एक डोमेन को टोकनाइज़ करते हैं, तो परिणामी डोमेन NFT आपके वॉलेट में स्टोर होता है, जिससे आपको सीधा [कस्टोडियल ओनरशिप](/hi/glossary/custodial-ownership/) और कंट्रोल मिलता है। लोकप्रिय वॉलेट में MetaMask, Coinbase Wallet और Ledger जैसे हार्डवेयर वॉलेट शामिल हैं। आपका वॉलेट केंद्रीकृत प्लेटफॉर्म पर निर्भर किए बिना आपके टोकनाइज़्ड डोमेन को मैनेज करने, ट्रांसफर करने और उनके साथ इंटरैक्ट करने का आपका पोर्टल बन जाता है।