---
title: 'UrbanCompass.comからCompass.comへ：「Urban」を外すことでNYCの賃貸アプリが全国規模の不動産仲介会社へ変貌した経緯'
date: '2026-06-17'
language: ja
...
seriesOrder: 20
format: case-study
description: 'Urban Compassが2012年にUrbanCompass.comでニューヨークの賃貸アプリとしてスタートし、2015年2月のリブランドで「Urban」を外してCompass.comへアップグレードするまでの経緯——100万ドルでオークション出品されていたこのドメインを、全国展開を目前に取得した戦略的決断を解説する。'
keywords: ['urbancompass.com', 'compass.com', 'compassドメイン名', 'ドメインアップグレード', 'urban compassリブランド', 'robert reffkin', 'ori allon', 'スタートアップ命名', 'ブランド命名', 'プレミアムドメイン', 'ドメイン戦略', 'compass不動産', '不動産スタートアップ', '完全一致ドメイン']
relatedArticles:
...
![都市的な黒白のコンパスロゴから「Urban」という文字が剥がれ落ちるカラフルな編集イラスト——コンパスの針がマンハッタンの密な街路図から米国全土の広い地図へと向きを変えていく](../../assets/from-urbancompass-com-to-compass-com-01-dropping-urban.jpg)
...
![米国の様式化された地図全体に、黒いCompassの庭先看板が次々と植えられていくカラフルな編集イラスト——マンハッタンのブロックからワシントンD.C.のタウンハウス、サンベルトの郊外まで——各看板に「Compass.com」と書かれ、単一のコンパスローズのモチーフが都市をつなぐ](../../assets/from-urbancompass-com-to-compass-com-02-going-national.jpg)
...
![プレミアムドメインが検証済み移転を経由し、緑のNamefiトークンとDNSの継続性を示すカラフルなイラスト](../../assets/from-urbancompass-com-to-compass-com-03-namefi-angle.jpg)
