...
Pour le parcours avec transfert entrant, vous devrez récupérer le **code d'autorisation** (parfois appelé code EPP) auprès de votre registrar actuel et le coller dans Namefi. Vous pourriez également avoir besoin de :
...
Une fois le domaine passé sous l'intégration du registrar Namefi, vous serez invité à **minter** (créer) sa représentation [NFT](/fr/glossary/nft/) (un jeton standard [ERC-721](/fr/glossary/erc-721/)). Votre portefeuille s'ouvre ; vous confirmez la transaction ; le gaz est payé ; et le jeton atterrit dans votre portefeuille.
...
- Un NFT on-chain dans votre portefeuille, représentant la propriété du domaine.
