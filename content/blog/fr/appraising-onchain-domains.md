...
**La liquidité est structurelle.** Un nom tokenisé se règle en un seul [transfert atomique](/fr/glossary/atomic-transfer/) lorsque l''acheteur paie — pas d''agent d''entiercement, pas de fenêtre de transfert — ce qui rend la [liquidité](/fr/glossary/domain-liquidity/) onchain des domaines plus élevée et les comps plus frais. C''est le même mécanisme qui vous permet de vendre un nom [en tant que NFT](/fr/blog/selling-domains-as-nfts/) sans intermédiaire ; nous le couvrons dans [comment les places de marché tokenisées remplacent l''entiercement](/fr/blog/how-tokenized-marketplaces-replace-escrow/).
...
- Ethereum Improvement Proposals — [ERC-721 : norme de jeton non fongible (API standard pour les NFT au sein des smart contracts)](https://eips.ethereum.org/EIPS/eip-721#:~:text=The%20following%20standard%20allows%20for%20the%20implementation%20of%20a%20standard%20API%20for%20NFTs)
