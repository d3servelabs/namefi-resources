...
2. **Vérifiez comment ils sont payés, et quand.** Un courtier légitime est payé une commission sur une vente réussie, via un processus d'[escrow](/en/glossary/escrow/) neutre. Quiconque demande des frais initiaux importants pour « évaluer », « lister » ou « commercialiser » votre nom avant toute vente a un autre business, et c'est souvent celui de l'arnaque à l'évaluation. Le courtage légitime côté vendeur est très majoritairement basé sur le succès.
3. **Confirmez qu'ils utilisent un véritable service d'escrow et un transfert propre.** Le courtier devrait insister sur l'utilisation d'un tiers neutre pour détenir les fonds, et devrait comprendre les [mécanismes de transfert](/en/blog/how-to-sell-a-domain-name-you-own/) et les périodes de blocage sur le bout des doigts. Un courtier qui prend la passation à la légère est un courtier qui vous fera perdre une vente, ou un nom. Pour savoir comment ces passations sont attaquées, [comment le détournement de domaine se produit réellement](/en/blog/how-domain-hijacking-actually-happens/) est la lecture de mise en garde.
...
5. **Parlez à la communauté au sens large.** Les [forums de traders de domaines](/en/blog/top-domain-trader-forums/) et les [blogs et newsletters de domainers](/en/blog/famous-domainer-blogs-and-newsletters/) regorgent de personnes qui ont travaillé avec des courtiers spécifiques et vous diront, souvent sans détour, qui est sérieux. Les [médias de l'industrie du domaine](/en/blog/domain-industry-media/) plus larges sont un autre moyen de vérifier la réputation. Dans ce secteur, la réputation voyage vite.
...
La raison pour laquelle les courtiers occupent une place si importante dans les transactions de grande valeur est que la passation est véritablement effrayante : prouver qui détient le nom, le transférer sans que le site ne tombe, et faire confiance à l'autre partie pour livrer sa part. Un bon courtier gère cette friction avec des relations et des processus. [Namefi](https://namefi.io) s'attaque à cette friction elle-même. La propriété tokenisée rend le contrôle d'un vrai domaine ICANN plus facile à vérifier et à transférer, avec une continuité DNS pour que le nom continue de se résoudre correctement pendant la passation. Cela ne remplace pas un excellent négociateur sur un nom à sept chiffres, mais cela réduit la partie de la transaction où la confiance était auparavant le seul liant. Si vous voulez une perspective plus large, consultez [comment les places de marché tokenisées remplacent l'escrow](/en/blog/how-tokenized-marketplaces-replace-escrow/).
