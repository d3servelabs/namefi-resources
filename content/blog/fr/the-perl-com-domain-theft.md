...
4. **Les règles de transfert fonctionnent dans les deux sens.** Le verrou de transfert de 60 jours après mise à jour censé *protéger* les propriétaires est devenu la salle d'attente de l'attaquant. La patience combinée au blanchiment à travers des registrars et des frontières a transformé une correction rapide en une récupération multi-parties s'étalant sur plusieurs semaines.
