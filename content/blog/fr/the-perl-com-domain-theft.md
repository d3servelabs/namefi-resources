...
Pourquoi une si longue attente ? Parce que les règles de [transfert de domaine](/fr/glossary/domain-forwarding/) récompensent la patience. ["L'ICANN interdit le transfert d'un domaine pendant 60 jours suivant la mise à jour des informations de contact."](https://www.securityweek.com/hackers-control-perlcom-domain-months-hijack/#:~:text=ICANN%20prohibits%20the%20transfer%20of%20a%20domain%20for%2060%20days%20following%20the%20updating%20of%20contact%20info.) Un attaquant qui s'empare discrètement d'un compte registrar en septembre ne peut pas immédiatement transférer le domaine — il a donc attendu, laissé le délai s'écouler, et a agi une fois le verrou expiré.
