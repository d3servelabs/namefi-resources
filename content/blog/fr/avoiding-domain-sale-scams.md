...
seriesOrder: 18
format: guide
description: "Les arnaques courantes à la vente de domaines — faux services d'entiercement, faux acheteurs, rétrofacturations pour trop-perçu, transfert avant paiement — et les habitudes qui sécurisent vos ventes."
ogImage: ../../assets/avoiding-domain-sale-scams-og.jpg
keywords: ['arnaques vente de domaines', 'éviter arnaques domaines', 'faux site d''entiercement', 'faux entiercement', 'arnaque faux acheteur de domaine', 'arnaque au trop-perçu', 'fraude à la rétrofacturation', 'transfert avant paiement', 'vendre un domaine en toute sécurité', 'entiercement de domaine', 'fraude à la vente de domaine', 'faux courtier de domaine', 'arnaque au transfert de domaine', 'transaction de domaine sécurisée', 'sécurité du domaineur']
---

Dans le [flipping de domaines](/fr/blog/domain-flipping/), l'argent se gagne lorsque le nom est enfin vendu. C'est aussi précisément à ce moment que les arnaqueurs entrent en scène. Une annonce de vente active est une invitation ouverte à quiconque est prêt à se faire passer pour un acheteur, un courtier ou une société d'entiercement. L'erreur la plus coûteuse qu'un flipper puisse commettre n'est pas d'acheter le mauvais nom. C'est de remettre un bon nom à la mauvaise personne.

Presque toutes les arnaques à la vente de domaines sont une variation d'une seule manœuvre : vous amener à céder soit le domaine, soit l'argent, avant que l'autre partie n'ait réellement livré sa part. Une fois que vous comprenez cette manœuvre, les défenses sont simples et ne ralentissent que très peu une transaction légitime. Ce guide décortique les arnaques que vous rencontrerez réellement, puis les habitudes qui les déjouent toutes. Il fait partie de la série sur les [compétences en flipping de domaines](/fr/blog/domain-flipping/) et est étroitement lié à l'aspect juridique abordé dans [le flipping de domaines et la loi](/fr/blog/domain-flipping-and-the-law/).

## Le seul stratagème derrière chaque arnaque : qui agit en premier

Toute vente entre inconnus se heurte à la même impasse. L'acheteur ne veut pas payer avant d'obtenir le domaine, et le vendeur ne veut pas transférer le domaine avant d'être payé. Quelqu'un doit faire le premier pas, et faire le premier pas signifie faire confiance à l'autre partie. C'est tout le problème que [l'entiercement](/fr/glossary/escrow/) a été inventé pour résoudre, et nous en couvrons les mécanismes dans [l'entiercement de domaine expliqué](/fr/blog/domain-escrow-explained/).
...
![Illustration éditoriale d'un loup en maillot d'arbitre rayé manipulant comme une marionnette un faux site d'entiercement d'apparence professionnelle mais vide, soutenu comme une façade de théâtre.](../../assets/avoiding-domain-sale-scams-01-fake-escrow.jpg)
...
Wikipédia décrit le schéma simplement : [l'arnaque au faux entiercement est un simple abus de confiance dans lequel un escroc exploite un faux service d'entiercement](https://en.wikipedia.org/wiki/Bogus_escrow#:~:text=The%20bogus%20escrow%20scam%20is%20a%20straightforward%20confidence%20trick%20in%20which%20a%20scammer%20operates%20a%20bogus%20escrow%20service). Le faux site existe pour vous mentir au moment précis où vous êtes le plus attentif. Comme le dit Wikipédia, [ce faux service d'entiercement assure à la victime que l'escroc a envoyé son article et que la victime doit envoyer son article au service d'entiercement](https://en.wikipedia.org/wiki/Bogus_escrow#:~:text=This%20bogus%20escrow%20service%20assures%20the%20victim%20that%20the%20scammer%20has%20sent%20its%20item). Vous voyez « l'acheteur a approvisionné l'entiercement », vous transférez le domaine pour conclure la vente, et l'argent n'a jamais été là. Le site disparaît, tout comme l'acheteur.
...
![Illustration éditoriale d'une personnalité d'affaires souriante qui est en réalité un masque en papier découpé tenu devant une silhouette creuse, avec un faux badge d'identification et une enveloppe d'e-mail, révélés par une loupe.](../../assets/avoiding-domain-sale-scams-02-fake-buyer.jpg)
...
Ces attaques reposent sur un nom qui semble plus légitime qu'il ne l'est, c'est l'une des raisons pour lesquelles il est judicieux de consulter les registres de propriété. Une recherche [WHOIS](/fr/glossary/whois/) rapide et une recherche sur l'entreprise que l'« acheteur » prétend représenter feront souvent s'effondrer l'histoire en moins d'une minute. Les vrais acheteurs survivent à une recherche Google. Les acheteurs inventés, non.

## Arnaques au trop-perçu et à la rétrofacturation

![Illustration éditoriale d'un sac d'argent rempli de pièces sur un hameçon, tiré en arrière par une flèche inversée, tandis qu'un plus petit paiement de remboursement s'écoule dans la direction opposée.](../../assets/avoiding-domain-sale-scams-03-chargeback.jpg)
...
Ne transférez jamais en premier. Une fois qu'un domaine quitte votre contrôle, votre moyen de pression a disparu, et le récupérer signifie un litige lent et incertain plutôt qu'un remboursement. C'est d'autant plus important en raison du fonctionnement réel des transferts. Déplacer un domaine vers un autre [bureau d'enregistrement](/fr/glossary/registrar/) nécessite que vous donniez le [code d'autorisation](/fr/glossary/auth-code/) — Wikipédia note que l'acheteur [obtient le code d'authentification (code de transfert EPP) de l'ancien bureau d'enregistrement](https://en.wikipedia.org/wiki/Domain_name_transfer#:~:text=obtains%20the%20authentication%20code%20%28EPP%20transfer%20code%29) — et une fois que ce code est transmis et que le transfert est terminé, le nom leur appartient. La même source note que [le processus peut prendre environ cinq jours](https://en.wikipedia.org/wiki/Domain_name_transfer#:~:text=The%20process%20may%20take%20about%20five%20days), et après son arrivée, il y a une période de verrouillage avant qu'il puisse être déplacé à nouveau, qui était de 60 jours et, selon Wikipédia, cette [politique de verrouillage de transfert de 60 jours a été éliminée, remplacée par une période de verrouillage de 30 jours](https://en.wikipedia.org/wiki/Domain_name_transfer#:~:text=replaced%20with%20a%2030%2Dday%20lock%20period). Rien de tout cela ne vous aide si vous avez déjà donné le nom à un voleur.
...
**Utilisez toujours un règlement réel, soutenu par un entiercement, et choisissez-le vous-même.** Insistez sur un service d'entiercement réputé ou une [place de marché](/fr/glossary/marketplace/) que *vous* proposez. La neutralité ne fonctionne que si vous avez choisi l'arbitre. Si un acheteur refuse votre service d'entiercement et exige le sien, la transaction est terminée — ce refus est le diagnostic. Notre guide complet sur la manière dont cela devrait se dérouler se trouve dans [l'entiercement de domaine expliqué](/fr/blog/domain-escrow-explained/) et la liste de contrôle du vendeur dans [comment vendre un nom de domaine que vous possédez](/fr/blog/how-to-sell-a-domain-name-you-own/).
...
[Namefi](https://namefi.io) réduit cet écart en tokénisant la propriété de vrais domaines ICANN, de sorte que le contrôle du nom et le règlement de la transaction peuvent être vérifiés et échangés ensemble, avec une continuité du DNS pour que le nom continue de se résoudre tout au long du transfert. Lorsque l'actif est auditable et le [transfert atomique](/fr/glossary/atomic-transfer/), le problème du « qui agit en premier » — ce que chaque arnaque de ce guide attaque — a beaucoup moins d'espace pour se cacher. Nous explorons ce changement dans [comment les places de marché tokénisées remplacent l'entiercement](/fr/blog/how-tokenized-marketplaces-replace-escrow/).
...
- Wikipédia — [Bogus escrow (définition et mécanique de l'arnaque au faux entiercement)](https://en.wikipedia.org/wiki/Bogus_escrow#:~:text=The%20bogus%20escrow%20scam%20is%20a%20straightforward%20confidence%20trick%20in%20which%20a%20scammer%20operates%20a%20bogus%20escrow%20service)
...
- Ressources Namefi — [Domain escrow explained](/fr/blog/domain-escrow-explained/) · [How to sell a domain name you own](/fr/blog/how-to-sell-a-domain-name-you-own/) · [How domain hijacking actually happens](/fr/blog/how-domain-hijacking-actually-happens/)
