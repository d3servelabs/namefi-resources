...
Ce guide est la couche psychologique qui sous-tend les choix mécaniques décrits dans [comment vendre des domaines pour en tirer profit](/fr/blog/how-to-sell-domains-for-profit/), le pilier de la vente de notre série sur le [domain flipping](/fr/blog/domain-flipping/). Nous aborderons l'effet de l'ancrage sur une négociation, pourquoi nommer le premier chiffre est un piège à double tranchant, comment négocier par paliers au lieu de céder, et comment le choix entre l'achat immédiat et la possibilité de [faire une offre](/fr/glossary/make-offer/) décide discrètement de l'issue avant même qu'un seul message ne soit envoyé.
...
Annoncez un prix trop bas et vous avez ancré le prix *contre vous-même*. Vous ne pouvez pas revenir en arrière : l'acheteur sait maintenant que votre plancher était en dessous de son budget, et aucune affirmation du type « d'autres sont intéressés » ne pourra le faire remonter. De nombreux revendeurs ont demandé 1 500 $ pour un nom qu'un [utilisateur final](/fr/glossary/end-user/) aurait volontiers payé 15 000 $, parce qu'ils l'ont tarifé comme s'ils s'adressaient à un autre investisseur achetant du stock sur le marché du [domain trading](/fr/glossary/domain-trading/) plutôt qu'à une entreprise achetant un outil. Cet écart entre le prix pour un [revendeur](/fr/glossary/reseller/) et celui pour un utilisateur final est l'erreur la plus coûteuse à commettre, et nous l'analysons en détail dans [comment évaluer un nom de domaine](/fr/blog/how-to-value-a-domain-name/) et dans [ventes de domaines entrantes vs sortantes](/fr/blog/inbound-vs-outbound-domain-sales/).
