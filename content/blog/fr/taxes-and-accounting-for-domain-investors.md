...
![Illustration éditoriale d''un nom de domaine unique qui bifurque en deux chemins, l''un vers un portefeuille d''investissement représentant une immobilisation et l''autre vers un rack de cartes identiques détenues en stock destiné à la vente](../../assets/taxes-and-accounting-for-domain-investors-01-inventory-vs-capital.jpg)
...
![Illustration éditoriale d''un nom de domaine relié à des reçus, une facture sous une loupe et un calendrier indiquant la date d''acquisition, représentant les documents justificatifs de la base de coût](../../assets/taxes-and-accounting-for-domain-investors-02-cost-basis.jpg)
...
![Illustration éditoriale d''un coût de renouvellement récurrent qui s''écoule d''une carte de domaine vers une bifurcation entre la déduction en une seule année et l''amortissement sur une longue durée pluriannuelle](../../assets/taxes-and-accounting-for-domain-investors-03-expense-renewals.jpg)
