...
- IETF / Cloudflare Docs — Comportement de mise en cache négative DNS (RFC 2308, RFC 9520) et modèles [DNSSEC](/fr/glossary/dnssec/) multi-signataires pour les déploiements faisant autorité multi-fournisseurs (RFC 8901, documentation opérateur). ([RFC Editor](https://www.rfc-editor.org/rfc/rfc8901), [RFC Editor](https://www.rfc-editor.org/rfc/rfc9520))