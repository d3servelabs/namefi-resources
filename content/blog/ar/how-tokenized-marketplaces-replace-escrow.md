...
7. تأكيد عملية النقل؛ ثم تقوم خدمة [الضمان](/ar/glossary/collateral/) بتحرير الأموال.
...
2. يقوم المشتري بالدفع. ينتقل [الرمز غير القابل للاستبدال (NFT)](/ar/glossary/nft/) إلى [محفظة](/ar/glossary/wallet/) المشتري. يتم إبقاء [السجل](/ar/glossary/registry/) من جانب مسجل النطاقات متزامناً بواسطة المنصة.
3. تمت العملية.
...
(إذا أراد المشتري لاحقاً *إلغاء [ترميز](/ar/glossary/tokenize/)* النطاق ونقله إلى مسجل مختلف تماماً، فهذه عملية منفصلة ستعيد تفعيل آلية نقل المسجل التقليدية — بما في ذلك رموز المصادقة وكل ما يتعلق بها).
