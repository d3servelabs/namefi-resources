...
الموضوع نفس هيكل اسم النطاق. `whitehouse.gov` موثوق فيه مش لأن كل زائر بيفحص سلسلة الشهادات، لكن لأن الاسم نفسه بيحمل السلطة. تتحكم في الاسم ده — عند شركة التسجيل، في إعدادات [DNS](/ar/glossary/dns/)، في لوحة الإدارة — وهتورث كل الثقة اللي الناس ضختها فيه على طول، سواء كان إبتداءً بتاعتك أو لأ.
