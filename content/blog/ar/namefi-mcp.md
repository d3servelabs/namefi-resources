...
| `listOutboundLeads` | `GET /v-next/outbound/runs/{runId}/leads` | يسرد العملاء المحتملين للمشترين مرتبين، وكل واحد معه مبرر وجهات اتصال مكتشفة وأي مسودة تواصل موجودة | مفتاح API |
