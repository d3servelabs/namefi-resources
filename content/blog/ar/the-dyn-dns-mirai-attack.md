...
كل مرة بتكتب فيها اسم نطاق، الكمبيوتر بتاعك محتاج يترجمه ل[عنوان IP](/ar/glossary/ip-address/) رقمي قبل ما يتصل بأي حاجة. الترجمة دي هي شغل DNS، [نظام أسماء النطاقات](/ar/glossary/dns/). هو طبقة البحث بين الاسم اللي بني آدم يفهمه والماكينة اللي الاسم بيشير إليها.
