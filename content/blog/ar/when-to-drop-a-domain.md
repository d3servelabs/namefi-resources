...
الدليل ده عن قرار التخلي عن الدومين: الموازنة بين رسوم التجديد واحتمالات إعادة البيع الواقعية، واكتشاف فخ التكلفة الغارقة اللي بيخلي الدومينات السيئة على أجهزة الإنعاش، والعلامات اللي بتقول إن الدومين ده عمره ما هيتباع. ده الجزء المكمل لعملية الشراء الصح — وهو نظام بنغطيه في سلسلة [تقليب الدومينات (domain flipping)](/en/blog/domain-flipping/)، وعلى مستوى المحفظة في [إدارة محافظ الدومينات (domain portfolio management)](/en/blog/domain-portfolio-management/).

## فاتورة التجديد هي أساس اللعبة

ابدأ بالرقم اللي أنت بتقرر بشأنه فعلاً. الدومين مش بيتشري مرة واحدة؛ هو بيتأجر لفترات، وتسجيل gTLD بيوصل كحد أقصى، حسب ويكيبيديا، [لـ 10 سنين كأقصى فترة تسجيل لاسم نطاق gTLD](https://en.wikipedia.org/wiki/Domain_name_registrar#:~:text=The%20maximum%20period%20of%20registration%20for%20a%20gTLD%20domain%20name%20is%2010%20years). أياً كانت المدة اللي اخترتها، ميعاد التجديد هييجي، وبالنسبة لدومين عادي زي [`.com`](/en/tld/com/) بتبقى التكلفة بسيطة — ويكيبيديا بتشير إنه من 2023، [تكلفة التجزئة بتتراوح عمومًا من حوالي 9.70 دولار في السنة لـ 35 دولار في السنة](https://en.wikipedia.org/wiki/Domain_name_registrar#:~:text=the%20retail%20cost%20generally%20ranges%20from%20a%20low%20of%20about%20%249.70%20per%20year) للتسجيل البسيط.

عشرة أو عشرين دولار ممكن تحسهم مبلغ تافه، وهو ده الفخ بالظبط. الرسوم لكل اسم صغيرة؛ لكن الرسوم على مستوى المحفظة كلها مش صغيرة. مستثمر الدومينات اللي عنده 300 اسم بيكتب شيك بأربع أرقام منخفضة كل سنة عشان بس يفضلوا شغالين، ومعظم المبلغ ده بيروح على دومينات عمرها ما هتتباع. مع الامتدادات المميزة الوضع أصعب — دومين [`.io`](/en/tld/io/) أو [`.ai`](/en/tld/ai/) ممكن يكلف أضعاف تكلفة تجديد `.com`، فدومين `.ai` واحد ميت بيشيل وزن تجديد عشرات من دومينات `.com`. فاتورة التجديد هي تكلفة الاحتفاظ بمخزونك، وقرار التخلي عن الدومين هو تحكم في التكاليف على مستوى المحفظة. بنفصص الحسبة دي في [تكاليف تجديد الدومين ومعدل البيع](/en/blog/domain-renewal-costs-and-sell-through-rate/).
...
- **مشكلة علامة تجارية مفوتهاش وقت التسجيل.** أحيانًا هتدرك إن الدومين معتمد على علامة تجارية بتاعت حد تاني. تحت [UDRP](/en/glossary/udrp/) ده بيبقى مسئولية، مش أصل، والقرار الصح غالبًا هو إنك تسيبه بدل ما تخاطر بنزاع. الخط الفاصل بين استثمار الدومينات والاسكواتينج متغطي في [ما هو UDRP](/en/blog/what-is-udrp/).
