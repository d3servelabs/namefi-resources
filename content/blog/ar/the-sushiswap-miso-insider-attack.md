...
في سبتمبر 2021، الناس اللي كانوا بيشغّلوا منصة MISO على SushiSwap ما تعرضوش لتصيّد احتيالي، ومحدش سرق منهم مفتاح خاص، وما كانش في [عقد ذكي](/ar/glossary/smart-contract/) معيب. اللي حصل كان أعادي أكتر من كده: وثقوا في مساهم. مقاول مجهول كان عنده صلاحية الكتابة على الكود حطّ عنوان محفظته الخاصة في واجهة [المزاد](/ar/glossary/auction/) الأمامية، دفع التغيير، وسيب الـ pipeline يعمل الباقي. لما مزاد NFT واحد اتسوّى، حوالي **864.8 ETH — يعني تقريباً 3 مليون دولار** — راحت مش للمشروع اللي كان بيشغّل البيع، لكن للمطوّر اللي بهدوء أعاد كتابة المسار اللي المفروض الفلوس ترّوح فيه.
...
منصة [DeFi](/ar/glossary/defi/) زي MISO — اختصار لـ Minimal Initial SushiSwap Offering — موجودة عشان تعمل حاجة واحدة كويس: تاخد فلوس من مجموعة غرباء وتوصّلها لمشروع بيشغّل بيع توكن أو NFT. عشان تعمل ده، بتربط بين عقود ذكية متحقَّق منها [على السلسلة](/ar/glossary/on-chain/) وواجهة ويب أمامية خارج السلسلة. المستخدمون بيتعاملوا مع الواجهة الأمامية. الواجهة الأمامية بتقول لمحفظتهم إيه المعاملة اللي المفروض يوقّعوا عليها.
