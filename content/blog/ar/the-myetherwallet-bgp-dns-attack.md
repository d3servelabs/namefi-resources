...
الأولى هي **DNS** — دليل الهاتف على الإنترنت — اللي بيحوّل اسم زي `myetherwallet.com` ل[عنوان IP](/ar/glossary/ip-address/) رقمي. والثانية هي **BGP**، بروتوكول Border Gateway، اللي بيحدد إيه المسار الفعلي اللي الباكيتات بتسلكه للوصول لذلك العنوان. ما حدش تقريبًا بيفكر في أيٍّ منهم. بيشتغلوا وخلاص، مليارات المرات كل يوم، في صمت تام.
...
دي الاقتصاديات القاسية لهجوم التوجيه + DNS على [محفظة](/ar/glossary/wallet/) كريبتو. مفيش قسم رد المبالغ، مفيش استرداد، مفيش بنك تتصل بيه. لما المفاتيح الخاصة تُدخَل في موقع مزيف للمهاجم وتتحوّل الأموال على البلوك تشين، راحت.
...
معظم الناس بيفتكروا إن أمان الدومين معناه كلمة مرور قوية للمسجّل، وتحقق بخطوتين، وقفل الدومين. كل ده حقيقي وضروري — و**ما كانش أي منه هيوقف 24 أبريل 2018.** المهاجمون ما لمسوش المسجّل، ما لمسوش سجلات DNS الخاصة بـ MyEtherWallet، ما لمسوش سيرفراتها. [السجل](/ar/glossary/registry/)ات كانت بتقول الصح طول الوقت. الإنترنت بس بطّل يوصّل الاستعلامات للمكان اللي بيحتفظ بيها.
