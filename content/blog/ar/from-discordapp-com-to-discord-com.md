---
title: 'من DiscordApp.com إلى Discord.com: كيف أغلق حذف "App" بابًا كان المحتالون يعشقونه'
date: '2026-06-17'
language: ar
...
اللي بيخلي قصة Case 13 مختلفة عن قصة "اشتري نطاقك المطابق" العادية هو *الدرزة* اللي خلّفها الحل البديل ده. لمدة خمس سنين، كان Discord شغّال على عنوانين في نفس الوقت — العلامة اللي بيستخدمها (discordapp.com) والعلامة اللي عايزها (discord.com) — وهذا الانقسام بين النطاقين اتضح إنه بالظبط نوع الغموض اللي المحتالون والنصابون ومنتشرو البرامج الخبيثة بيتغذوا عليه. دي قصة ترقية نطاق كانت جزئيًا بسبب نظافة [العلامة التجارية](/ar/glossary/trademark/) وجزئيًا بسبب سد ثغرة أمنية كانت الشركة تعيش معاها من يوم ما انطلقت.
...
![رسم توضيحي حيّ بألوان Discord بنفسجية يُظهر لافتة طريق متفرّع، فرع يكتب عليه discord.com والآخر discordapp.com، ومسكوت Clyde بيبص بعصبية بين الاتجاهين وشخص محتال متنكّر في هودي مختبئ في الانعطافة](../../assets/from-discordapp-com-to-discord-com-02-phishing-risk.jpg)
...
![رسم توضيحي حيّ بالألوان الكاملة بنفسجية Discord يُظهر كلمة DiscordApp وهي تتخلص من لاحقة -App المضيئة، الأحرف بتتساقط والمسكوت Clyde بيبتسم، تاركًا علامة Discord نظيفة](../../assets/from-discordapp-com-to-discord-com-01-dropping-app.jpg)
...
![رسم توضيحي ملوّن لنطاق مميز ينتقل عبر تحويل ملكية موثّق، ورمز Namefi أخضر، واستمرارية DNS](../../assets/from-discordapp-com-to-discord-com-03-namefi-angle.jpg)
