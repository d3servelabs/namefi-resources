...
للأسئلة المرتبطة بشكل كبير واللي بتظهر أول ما الدومين يبقى على البلوكتشين — زي عمليات السك (minting)، المبيعات بالعملات المشفرة، هدايا التوكنز، والضمانات في التمويل اللامركزي (DeFi) — شوف المقال التاني عن [الأسئلة الضريبية والمحاسبية للدومينات المرمزة (tokenized domains)](/en/blog/tax-and-accounting-questions-for-tokenized-domains/). البوست ده عن الدومينات المسجلة العادية. الاتنين بيندرجوا تحت [تقليب الدومينات (domain flipping)](/en/blog/domain-flipping/) كمهارة وتحت [إدارة محافظ الدومينات (domain portfolio management)](/en/blog/domain-portfolio-management/) كنظام عمل.
...
بالنسبة لدومين سجلته يدويًا، الموضوع مباشر: رسوم التسجيل عند [المسجل (registrar)](/en/glossary/registrar/). بالنسبة لدومين اشتريته من [السوق الثانوية (aftermarket)](/en/glossary/marketplace/)، يبقى هو سعر الشراء، وهتحتاج تفكر في تكاليف الاستحواذ المرتبطة زي رسوم [خدمة الضمان (escrow)](/en/glossary/escrow/)، عمولات السماسرة، أو رسوم [المزاد (auction)](/en/glossary/auction/). هل كل واحدة من دول بتتضاف لأساس التكلفة ولا بتتخصم كمصروف، ده بالظبط النوع اللي لازم تتأكد منه مع متخصص، لأن الإجابة ممكن تعتمد على إذا كنت مستثمر ولا تاجر.
...
بالنسبة لمعظم المستثمرين، الحدث الخاضع للضريبة هو البيع، مش مجرد الاحتفاظ. مجرد تسجيل دومين، أو متابعة قيمته السوقية وهي بتزيد، أو يجيلك عرض مش طالبه وترفضه، كل ده في حد ذاته مش بيخلق دخل. الدخل بيظهر عمومًا لما تتصرف فعلًا في الدومين عن طريق [البيع](/en/blog/how-to-sell-a-domain-name-you-own/) وتحقق المكسب.
...
الصفقات المركبة بتضيف أسئلتها الخاصة. البيع بالتقسيط، [الإيجار](/en/glossary/leasing/) مع خيار الشراء، أو نظام [الإيجار المنتهي بالتمليك (rent-to-own)](/en/glossary/rent-to-own/) ممكن يوزع أو يعيد تصنيف الدخل على مدار سنين. ولا حاجة من دول غريبة في عالم الدومينات، وكل واحدة منهم سبب يخليك تسأل قبل ما تمضي، مش بعد.
...
هنا برضه [اقتصاديات التجديد ومعدل البيع بتاعك](/en/blog/domain-renewal-costs-and-sell-through-rate/) بتتقابل مع التخطيط الضريبي. حسبة تكلفة الحيازة اللي بتقولك [امتى تسيب دومين (drop)](/en/blog/when-to-drop-a-domain/) هي نفس الحسبة اللي المحاسب بتاعك محتاجها عشان يشوف شكل البزنس.
...
- مصادر Namefi — [الأسئلة الضريبية والمحاسبية للدومينات المرمزة (tokenized domains)](/en/blog/tax-and-accounting-questions-for-tokenized-domains/)
