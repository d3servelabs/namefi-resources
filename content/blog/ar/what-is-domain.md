...
يعتمد الإنترنت على نظام يسمى **[نظام أسماء النطاقات](/ar/glossary/dns/) (DNS)**، والذي يعمل مثل دليل هاتف عملاق. يتم استضافة كل موقع ويب على خادم له [عنوان IP](/ar/glossary/ip-address/) رقمي (مثل `192.0.2.1`)، ولكن الأرقام يصعب تذكرها — لذلك نستخدم أسماء النطاقات بدلاً من ذلك. عندما تكتب اسم نطاق في متصفحك، يقوم DNS بترجمته إلى عنوان IP المقابل، مما يسمح لمتصفحك بتحميل الموقع الصحيح.
...
*   **[نطاق المستوى الأعلى](/ar/glossary/tld/) (TLD):** هذا هو اللاحقة في نهاية العنوان، مثل `.com`، `.org`، `.net`، أو مؤخرًا، `.xyz`، `.app`، وحتى `.ninja`. بعضها عام (gTLDs)، بينما البعض الآخر خاص بالبلد (ccTLDs، مثل `.us`، `.uk`، أو `.cn`).
*   **نطاق المستوى الثاني ([SLD](/ar/glossary/second-level-domain/)):** هذا هو الجزء الأساسي من الاسم — كلمة `google` في `google.com`.
*   **[النطاق الفرعي](/ar/glossary/subdomain/) (Subdomain):** هذه هي بادئات اختيارية تساعد في تنظيم المحتوى، مثل `blog.example.com` أو `mail.example.org`.
...
تتم الإشراف على التنسيق العالمي لأسماء النطاقات من قبل منظمة غير ربحية تسمى **[ICANN](/ar/glossary/icann/)** (**مؤسسة الإنترنت للأسماء والأرقام المخصصة**). تأسست ICANN في عام 1998، وتدير تخصيص أسماء النطاقات وعناوين IP. وتعمل مع [السجل](/ar/glossary/registry/)ّات (مثل GoDaddy، Namecheap، و Namefi) الذين يبيعون أسماء النطاقات للجمهور.
...
*   **الهوية و[العلامة التجارية](/ar/glossary/trademark/) عبر الإنترنت** (على سبيل المثال، للشركات، والمبدعين، والشركات الناشئة).
*   **الثقة وقابلية الاكتشاف**، حيث يبدو النطاق المخصص أكثر احترافية من عنوان URL عشوائي.
*   **تحسين محركات البحث** ([SEO](/ar/glossary/seo/)).
