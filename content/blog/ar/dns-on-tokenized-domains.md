...
1. **طبقة [DNS](/en/glossary/dns/) / السجل (Registry)** — وهي نفس الطبقة التي كان يتواجد فيها نطاق `.com` الخاص بك دائماً. [ICANN](/en/glossary/icann/)، [مسجل النطاق (Registrar)](/en/glossary/registrar/)، خوادم الجذر (root servers)، والمحللات التكرارية (recursive resolvers).
2. **الطبقة [على السلسلة (On-chain)](/en/glossary/on-chain/)** — عبارة عن رمز غير قابل للاستبدال ([NFT](/en/glossary/nft/)) في [محفظتك](/en/glossary/wallet/) يمثل *الملكية*.
...
هذا هو الهدف الأساسي من العملية بأكملها. وهو أيضاً السبب الذي يجعلك تأخذ أمان المحفظة على محمل الجد — انظر [استرداد النطاق المرمز بعد فقدان المحفظة](/en/blog/recovering-a-tokenized-domain-after-wallet-loss/).
...
قبل الترميز: مسار [نقل النطاق بين المسجلين (cross-registrar transfer)](/en/glossary/cross-registrar-transfer/)، باستخدام [رموز المصادقة (auth codes)](/en/glossary/auth-code/) وفترات انتظار تصل إلى 60 يوماً.
بعد الترميز: يتم [**نقل رمز NFT**](/en/glossary/atomic-transfer/). معاملة واحدة على السلسلة تنقل الملكية. يتم الحفاظ على مزامنة السجل من جانب المسجل بواسطة البروتوكول. هذا أسرع بكثير — وهذا هو السبب في أن أسواق النطاقات المرمزة لا تحتاج إلى نظام [الضمان (escrow)](/en/glossary/escrow/) التقليدي (انظر [من الإدراج إلى التسوية](/en/blog/how-tokenized-marketplaces-replace-escrow/)).
...
يعمل بروتوكول الامتدادات الأمنية لنظام أسماء النطاقات ([DNSSEC](/en/glossary/dnssec/)) بشكل طبيعي. إذا قمت بتمكينه من قبل، فسيبقى ممكّناً. وإذا لم تكن قد فعلت ذلك، فيمكنك تمكينه بعد الترميز. تمر سلسلة الثقة (chain of trust) عبر السجل (registry) كالمعتاد — ولا تقع الطبقة التي على السلسلة في أي مكان على هذا المسار. (خلفية: تُعرّف [وثيقة RFC 4033](https://datatracker.ietf.org/doc/html/rfc4033) البروتوكول؛ وتصف [شروحات حفل KSK الخاص بـ ICANN](https://www.icann.org/dns-resolvers-checking-current-trust-anchors) عملية جذر الثقة).
...
للحصول على شرح تفصيلي على مستوى المشغل حول كيفية الترميز في المقام الأول، انظر [كيفية ترميز نطاق .com الخاص بك](/en/blog/how-to-tokenize-your-com/).