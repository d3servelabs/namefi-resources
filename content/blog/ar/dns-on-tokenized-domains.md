...
1. **طبقة [DNS](/ar/glossary/dns/) / السجل (Registry)** — وهي نفس الطبقة التي كان يتواجد فيها نطاق `.com` الخاص بك دائماً. [ICANN](/ar/glossary/icann/)، [مسجل النطاق (Registrar)](/ar/glossary/registrar/)، خوادم الجذر (root servers)، والمحللات التكرارية (recursive resolvers).
...
قبل الترميز: مسار [نقل النطاق بين المسجلين (cross-registrar transfer)](/ar/glossary/cross-registrar-transfer/)، باستخدام [رموز المصادقة (auth codes)](/en/glossary/auth-code/) وفترات انتظار تصل إلى 60 يوماً.
