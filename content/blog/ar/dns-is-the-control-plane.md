...
يحتاج كل تطبيق وموقع ويب إلى طريقة "للبحث" عن مكان الاتصال. يُسمى دليل عناوين الإنترنت هذا [DNS](/ar/glossary/dns/) — اختصاراً لنظام أسماء النطاقات (Domain Name System). في 20 أكتوبر، تسببت مشكلة في التسمية داخل AWS في عدم قدرة بعض أجهزة الكمبيوتر على العثور على خدمة قواعد بيانات رئيسية لـ AWS بالاسم. إذا لم يتمكن "دليل العناوين" من توفير الإدخال الصحيح في اللحظة المناسبة، فلن تتمكن حتى الأنظمة السليمة من التحدث مع بعضها البعض.
