...
يحتاج كل تطبيق وموقع ويب إلى طريقة "للبحث" عن مكان الاتصال. يُسمى دليل عناوين الإنترنت هذا DNS — اختصاراً ل[نظام أسماء النطاقات](/ar/glossary/dns/) (Domain Name System). في 20 أكتوبر، تسببت مشكلة في التسمية داخل AWS في عدم قدرة بعض أجهزة الكمبيوتر على العثور على خدمة قواعد بيانات رئيسية لـ AWS بالاسم. إذا لم يتمكن "دليل العناوين" من توفير الإدخال الصحيح في اللحظة المناسبة، فلن تتمكن حتى الأنظمة السليمة من التحدث مع بعضها البعض.

أصلحت AWS مشكلة التسمية المباشرة في غضون بضع ساعات، ثم قضت بقية اليوم في السماح بمسح [السجل](/ar/glossary/registry/)ات المتراكمة (backlogs) وإعادة الأنظمة تدريجياً إلى وضعها الطبيعي. بحلول وقت متأخر من بعد الظهر (بتوقيت المحيط الهادئ)، صرحت AWS أن كل شيء يعمل بشكل طبيعي مرة أخرى، على الرغم من أن بعض الخدمات استغرقت وقتاً أطول للتعافي الكامل.
...
- **IETF / Cloudflare Docs** — سلوك التخزين المؤقت السلبي لـ DNS (RFC 2308، RFC 9520) وأنماط [DNSSEC](/ar/glossary/dnssec/) متعددة التواقيع للنشر الموثوق متعدد المزودين (RFC 8901، وثائق المشغلين). ([RFC Editor](https://www.rfc-editor.org/rfc/rfc8901)، [RFC Editor](https://www.rfc-editor.org/rfc/rfc9520))