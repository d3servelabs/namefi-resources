...
كان ذلك الانتقال هو نقل Google Domains إلى Squarespace. والباب المفتوح كان الإعدادات الافتراضية لمصادقة Squarespace. والنتيجة كانت موجة منسّقة من اختطافات DNS استهدفت مشاريع كريبتو و DeFi تتحكم، بحسب أحد الباحثين، في مليارات الدولارات من الأصول.
...
لهذا تتوافق أدوات استنزاف المحافظ مثل Inferno مع اختطاف DNS توافقاً طبيعياً. أداة الاستنزاف لا تحتاج إلى سرقة كلمة مرور؛ تحتاج الضحية أن *تربط محفظتها وتوقّع*. والمستخدم الذي وصل عبر النطاق الحقيقي لبروتوكول الإقراض ليس لديه سبب للتردد قبل الموافقة على معاملة. الموقع المزيف يرث كل الثقة التي كسبها النطاق الشرعي على مدار سنوات.
...
اختطافات Squarespace ليست قصة خطأ إعداد في شركة واحدة. إنها قصة عن مكان وجود السيطرة الحقيقية على النطاق، وهشاشة الطبقة التي تعلو البلوكتشين.

ثمة دروس تتخطى يوليو 2024 بكثير:

1. **حساب مسجّل النطاق هو جذر الثقة الحقيقي — لا العقد الذكي.** لم يكن لدى أي من البروتوكولات المتضررة ثغرة في عقودها. كودها على السلسلة كان سليماً. استولى المهاجمون على *النطاق*، والنطاق هو ما يكتبه المستخدمون ويثقون به ويربطون محافظهم إليه. مشروع يمكن أن يكون مثالياً على السلسلة ومع ذلك يسلّم مستخدميه لمهاجم إذا كانت مستوى التحكم في DNS لديه ضعيفاً.
