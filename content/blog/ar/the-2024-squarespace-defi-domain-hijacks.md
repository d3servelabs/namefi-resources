...
كان ذلك الانتقال هو نقل Google Domains إلى Squarespace. والباب المفتوح كان الإعدادات الافتراضية لمصادقة Squarespace. والنتيجة كانت موجة منسّقة من اختطافات DNS استهدفت مشاريع كريبتو و [DeFi](/ar/glossary/defi/) تتحكم، بحسب أحد الباحثين، في مليارات الدولارات من الأصول.
