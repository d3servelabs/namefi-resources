...
[Namefi](https://namefi.io) بتنطلق من فكرة إن ملكية النطاق والتحكم فيه المفروض يتصرّفوا كأصل موثوق قابل للتحقق ومتعلق بالإنترنت بشكل أصيل — مش مجرد إدخال في قاعدة بيانات قابلة للتعديل يقدر مهاجم يعدّلها بهدوء. الملكية المُرمَّزة والقابلة للتدقيق بتخلّي السؤال "من اللي بيتحكم في هذا النطاق، وهل التحكم ده اتغيّر للتو؟" قابلاً للإجابة على السلسلة — محوّلاً تبديل الـ nameserver الصامت لحدث مرئي وخاضع للمساءلة، مع البقاء متوافقاً مع الـ DNS اللي بقية الإنترنت بتعتمد عليه. ده مش بيخلي الـ DNS نفسه يختفي، لكن بيخلّي *التحكم في اسم* أصعب اختطافاً بشكل غير مرئي وأسهل تحققاً بشكل مستمر.
