---
title: 'BufferApp.com에서 Buffer.com으로: 624일간의 도메인 거래, 은행 잔고까지 공개하다'
date: '2026-06-17'
language: ko
...
seriesOrder: 9
format: case-study
description: 'Buffer가 2010년에 Buffer.com을 확보하지 못해 BufferApp.com으로 출시한 뒤, 판매자에게 회사 은행 잔고까지 보여주며 624일에 걸쳐 정확히 일치하는 도메인을 인수한 과정, 그리고 과감한 투명 경영으로 유명한 이 회사가 왜 모두가 가장 알고 싶어 했던 단 하나의 숫자—거래 금액—만은 끝내 공개하지 않았는지를 살펴봅니다.'
keywords: ['bufferapp.com', 'buffer.com', 'buffer 도메인', '도메인 업그레이드', 'joel gascoigne', 'buffer 투명경영', '정확일치 도메인', '스타트업 네이밍', '브랜드 네이밍', '프리미엄 도메인', '도메인 전략', 'buffer 역사', '도메인 인수', '카테고리 정의 도메인']
relatedArticles:
...
![Buffer의 상징적인 파란색으로 "App" 접미사가 녹아 사라지는 BufferApp 단어를 표현한 선명한 컬러 일러스트. 예약된 소셜 포스트들이 줄지어 깔끔한 BUFFER 워드마크 하나로 슬라이드되는 장면](../../assets/from-bufferapp-com-to-buffer-com-01-dropping-app.jpg)
...
![협상 테이블 위에 펼쳐진 Buffer 파란색 은행 명세서와 두 손, 급진적 개방성의 빛, 도메인 열쇠 옆에 쌓인 동전들, 밝고 정직한 스타트업 오피스 분위기의 선명한 컬러 일러스트](../../assets/from-bufferapp-com-to-buffer-com-02-transparency.jpg)
...
![검증된 이전을 통과하는 프리미엄 도메인, 초록색 Namefi 토큰, DNS 연속성을 표현한 컬러 일러스트](../../assets/from-bufferapp-com-to-buffer-com-03-namefi-angle.jpg)
