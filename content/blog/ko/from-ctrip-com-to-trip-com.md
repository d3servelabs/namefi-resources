---
title: 'Ctrip.com에서 Trip.com으로: 중국의 여행 대기업이 1996년 도메인을 사들여 세계로 나간 방법'
date: '2026-06-17'
language: ko
...
seriesOrder: 10
format: case-study
description: '중국 최대 온라인 여행사 Ctrip이 2017년 Gogobot이라는 스타트업으로부터 프리미엄 도메인 Trip.com을 인수하고, 이를 글로벌 브랜드의 중심으로 재편한 후, 2019년에는 지주회사 전체의 이름을 Trip.com Group으로 변경하여 국제 시장으로 확장해 나간 과정을 살펴봅니다.'
keywords: ['ctrip.com', 'trip.com', 'ctrip 리브랜딩', 'trip.com group', 'trip.com 도메인', '도메인 업그레이드', '중국 브랜드 글로벌 확장', 'gogobot trip.com', '제임스 량 ctrip', '프리미엄 여행 도메인', '스타트업 네이밍', '브랜드 네이밍', '도메인 인수']
relatedArticles:
...
![Trip.com 글로브와 여행 가방 로고가 짙은 Trip.com 블루로 표현되어, 1996년 웹 선구자로부터 Galileo, Orbitz, Expedia를 거쳐 마침내 Ctrip의 손에 반짝이는 프리미엄 .com 바통처럼 전달되는 모습을 담은 다채로운 편집 일러스트레이션](../../assets/from-ctrip-com-to-trip-com-01-rebrand.jpg)
...
![붉고 금빛의 Ctrip 돌핀 로고가 깔끔한 Trip.com 블루 지구본 아이콘으로 변화하며, 중국 지도 위에서 런던, 서울, 도쿄의 스카이라인을 향해 떠오르고, 여행 가방과 탑승권이 밝은 하늘 아래 반짝이는 항공 경로를 따라 흘러가는 생동감 있는 풀컬러 편집 일러스트레이션](../../assets/from-ctrip-com-to-trip-com-02-going-global.jpg)
...
![프리미엄 도메인이 검증된 이전, 녹색 Namefi 토큰, DNS 연속성을 통해 이동하는 다채로운 일러스트레이션](../../assets/from-ctrip-com-to-trip-com-03-namefi-angle.jpg)
