---
title: 'MrChewy.com에서 Chewy.com으로: "Mr."를 떼어낸 한 글자가 어떻게 펫 스타트업을 33억 5천만 달러 브랜드로 바꿨나'
date: '2026-06-17'
language: ko
...
seriesOrder: 18
format: case-study
description: '2011년 펫 스타트업이 "Mr. Chewy"라는 이름으로 MrChewy.com에서 출발해 "Mr."를 떼어내고 정확 일치 도메인 Chewy.com으로 전환한 과정, 그리고 그 한 단어짜리 도메인 업그레이드가 PetSmart가 33억 5천만 달러에 인수한 브랜드의 일부가 된 이유를 살펴봅니다.'
keywords: ['mrchewy.com', 'chewy.com', 'chewy 도메인', 'mr chewy', '도메인 업그레이드', 'ryan cohen', 'michael day', 'frank schilling', '정확 일치 도메인', '스타트업 네이밍', '브랜드 네이밍', '프리미엄 도메인', '도메인 전략', '펫 이커머스']
relatedArticles:
...
![Chewy 블루 색상의 컬러풀한 편집 일러스트. 친근한 "Mr. Chewy" 상인 캐릭터가 중산모와 나비넥타이를 내려놓고 Chewy.com이라고 적힌 깔끔한 문을 통해 들어서는 장면](../../assets/from-mrchewy-com-to-chewy-com-01-dropping-mr.jpg)
...
![Chewy 블루 색상의 컬러풀한 편집 일러스트. 따뜻한 펫 이커머스 브랜드를 담은 이미지로, 개와 고양이 용품이 든 배송 박스, 헤드셋을 착용한 고객 서비스 담당자, 그리고 작은 위로의 꽃다발이 묘사되어 있으며, 마스코트 없이도 인간적인 브랜드를 전달합니다](../../assets/from-mrchewy-com-to-chewy-com-02-pet-brand.jpg)
...
![프리미엄 도메인이 검증된 이전 과정을 거쳐 녹색 Namefi 토큰과 DNS 연속성으로 이어지는 컬러풀한 일러스트](../../assets/from-mrchewy-com-to-chewy-com-03-namefi-angle.jpg)
