...
[`.co`](/en/tld/co) 在技术上是哥伦比亚的国家代码TLD，但2010年解除了属地限制，全球任何人均可注册（[维基百科：.co](https://en.wikipedia.org/wiki/.co)）。它被初创企业和无法获得 `.com` 的品牌广泛采用，值得注意的是，它是少数几个被谷歌视为通用非地理性后缀的国家代码TLD之一。由于 `.co` 只需多打一个字符就变成了 `.com`，抢注品牌 `.co` 域名兼具防御和战略双重意义。
