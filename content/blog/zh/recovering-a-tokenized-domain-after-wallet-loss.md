...
2. **注册局 / 注册商申诉。** 作为一个真实的 [ICANN](/zh/glossary/icann/) 域名，底层的注册记录依然存在。[注册商](/zh/glossary/registrar/)有相应的流程来证明所有权（[WHOIS / RDAP](/en/glossary/whois/) 历史记录、账单记录、政府颁发的身份证件）。这些流程非常缓慢、文件繁琐，且并不保证一定能成功——但它们确实是一条途径。
