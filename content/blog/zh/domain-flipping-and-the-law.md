...
法律是把双刃剑，这一点是大多数新手不知道的。有时，*商标所有者*才是恶意行事的一方，试图强行从合法注册人手中夺走他们并无实际权利的域名。该政策对此有专门的术语。[反向域名劫持](/zh/glossary/reverse-domain-hijacking/)[指合法的商标所有者试图通过对域名“网络抢注者”所有者提出网络抢注主张来获取该域名](https://en.wikipedia.org/wiki/Reverse_domain_name_hijacking#:~:text=occurs%20where%20a%20rightful%20trademark%20owner%20attempts%20to%20secure%20a%20domain%20name)。UDRP 规则将其定义为[恶意提起投诉，导致滥用 UDRP 行政程序](https://en.wikipedia.org/wiki/Reverse_domain_name_hijacking#:~:text=the%20filing%20of%20a%20complaint%20in%20bad%20faith%2C%20resulting%20in%20the%20abuse)。
