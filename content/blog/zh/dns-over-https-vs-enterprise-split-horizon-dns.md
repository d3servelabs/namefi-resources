...
在互联网历史的大部分时间里，DNS 查询都是通过 53 端口以明文形式传输的。网络路径上的任何人都可以读取、记录甚至修改这些查询。这是一个隐私隐患，IETF 最终通过推出两种加密替代方案来解决这个问题：2016 年的 [DNS over TLS (DoT, RFC 7858)](https://datatracker.ietf.org/doc/html/rfc7858) 和 2018 年的 [DNS over HTTPS (DoH, RFC 8484)](https://datatracker.ietf.org/doc/html/rfc8484)。
