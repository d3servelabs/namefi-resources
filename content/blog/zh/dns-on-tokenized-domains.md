...
1. **[DNS](/zh/glossary/dns/) / [注册局](/zh/glossary/registry/)层** —— 您的 `.com` 域名一直存在的地方。包含 [ICANN](/zh/glossary/icann/)、[注册商](/zh/glossary/registrar/)、[根服务器](/zh/glossary/root-zone/)和递归解析器。
2. **[链上](/zh/glossary/on-chain/)层** —— 您[钱包](/zh/glossary/wallet/)中的一个 [NFT](/zh/glossary/nft/)，代表了域名的*所有权*。

DNS 解析（将 `example.com` 转换为 [IP 地址](/zh/glossary/ip-address/)）完全发生在第 1 层。链上层关乎的是**谁拥有该域名的控制权**，而不是它如何解析。浏览器、电子邮件服务器、CDN 和证书颁发机构永远不需要知道[区块链](/zh/glossary/blockchain/)的存在。
