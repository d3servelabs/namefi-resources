...
1. **[DNS](/zh/glossary/dns/) / 注册局层** —— 您的 `.com` 域名一直存在的地方。包含 [ICANN](/zh/glossary/icann/)、[注册商](/zh/glossary/registrar/)、根服务器和递归解析器。
...
之前：需要走[跨注册商转移](/zh/glossary/cross-registrar-transfer/)流程，依赖[授权码 (Auth Codes)](/en/glossary/auth-code/)，并有 60 天的冷却期。
