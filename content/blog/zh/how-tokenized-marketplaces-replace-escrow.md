...
2. 进行价格谈判。
3. 在 [Escrow.com](https://www.escrow.com/) 或类似平台开启[第三方托管（Escrow）](/en/glossary/escrow/)。买方电汇资金。
...
6. 等待 5–7 天以完成 [ICANN](/en/glossary/icann/) 的转移流程。
7. 确认转移；托管方释放资金。
...
1. 在[交易市场](/en/glossary/marketplace/)（如 Namefi 官方市场、Doma、[OpenSea](https://opensea.io/)、[Blur](https://blur.io/) 等）上架[代币化域名](/en/blog/what-are-tokenized-domains/)。
2. 买方付款。[NFT](/en/glossary/nft/) 转移到买方的[钱包](/en/glossary/wallet/)。平台会自动保持[注册商](/en/glossary/registrar/)端的记录同步。
3. 完成。

就是这样。仅仅两步。没有[授权码](/en/glossary/auth-code/)，没有[托管](/en/glossary/escrow/)，没有 5 天的注册商锁定限制，也没有“我钱打过去了，现在只能相信你了”的信任空档期。

这之所以可行，是因为 **NFT 是所有权的权威记录**，而且[链上](/en/glossary/on-chain/)交易是[原子化](/en/glossary/atomic-transfer/)的：付款和资产转移在同一个区块内同时发生，要么同时成功，要么双双失效。
...
在某些司法管辖区，以加密货币支付的销售与以法定货币支付的销售属于不同的税务事件。请参阅[代币化域名的税务与会计问题文章](/en/blog/tax-and-accounting-questions-for-tokenized-domains/)，了解您可以向注册会计师（CPA）咨询的问题清单。
...
如果您想亲自尝试出售代币化域名，请访问 [namefi.io](https://namefi.io)。如需了解更宏观的行业图景，请参阅[《2026 年代币化域名的应用用例》](/en/blog/tokenized-domain-use-cases-2026/)。