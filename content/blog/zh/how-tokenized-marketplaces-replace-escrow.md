...
[代币化域名](/zh/glossary/tokenized-domain/)销售将这整个过程压缩成了一笔交易。本文将解释这是如何实现的，以及信任究竟转移到了哪里。
...
2. 买方付款。[NFT](/zh/glossary/nft/) 转移到买方的[钱包](/zh/glossary/wallet/)。平台会自动保持注册商端的记录同步。
3. 完成。
...
**被[智能合约](/zh/glossary/smart-contract/)的原子性所取代。** 交易要么完全成功（你拿到资产，对方拿到钱），要么根本不发生（双方都没有任何资金或资产变动）。绝对不存在一方资产已转移而另一方未履行的情况。
...
这会增加一些工作量，但对于[顶级域名](/zh/glossary/tld/)来说，它能显著扩大潜在买家群体。
