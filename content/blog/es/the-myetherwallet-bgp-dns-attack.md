...
Esa es la brutal economía de un ataque de enrutamiento más DNS sobre una [billetera](/es/glossary/wallet/) de criptomonedas. No hay departamento de reversión de fraudes, no hay contracargo, no hay banco al que llamar. Una vez que las claves privadas se ingresan en el clon del atacante y los fondos se mueven en la cadena, están perdidos.
...
4. **La finalidad [en cadena](/es/glossary/on-chain/) elimina la red de seguridad.** Para un inicio de sesión bancario, una sesión envenenada es grave. Para una billetera de criptomonedas, es irreversible. El mismo ataque contra otro tipo de sitio habría sido un susto; aquí fue una pérdida permanente.
