...
2. El comprador paga. El [NFT](/es/glossary/nft/) se transfiere a la [billetera (wallet)](/es/glossary/wallet/) del comprador. El [registro](/es/glossary/registry/) del lado del registrador es mantenido en sincronía por la plataforma.
3. Listo.

Eso es todo. Dos pasos. Sin código de autorización, sin escrow, sin bloqueo de registrador de 5 días, sin la incertidumbre de "ya envié el dinero, ahora confío en ti".
...
Nada en un [dominio tokenizado](/es/glossary/tokenized-domain/) te impide listarlo también a la antigua. Muchos propietarios listan:
