...
- Documentos IETF / Cloudflare — Comportamiento de almacenamiento en caché negativo de DNS (RFC 2308, RFC 9520) y patrones [DNSSEC](/es/glossary/dnssec/) [multifirma](/es/glossary/multi-sig/) para implementaciones autoritativas multiproveedor (RFC 8901, documentos de operador). ([RFC Editor](https://www.rfc-editor.org/rfc/rfc8901), [RFC Editor](https://www.rfc-editor.org/rfc/rfc9520))