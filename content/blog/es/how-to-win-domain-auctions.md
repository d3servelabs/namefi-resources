...
**Separa el nombre de las métricas.** A las subastas de expiraciones les encanta mostrar la antigüedad, los backlinks y el tráfico, y estos pueden ser valor real o spam reciclado, perfiles de enlaces manipulados y tráfico que se evapora en el momento en que el contenido antiguo desaparece. Trata las métricas impresionantes como una razón para investigar, no como una razón para pujar. El valor de reventa para un usuario final real generalmente reside en la cadena de caracteres en sí, no en un historial de [SEO](/es/glossary/seo/) que no puedes verificar por completo.
