...
- **Propiedad verificable.** Cualquier cosa que permita a un comprador confirmar que posees el nombre (un [WHOIS](/en/glossary/whois/) consistente, una insignia de un `marketplace` o una prueba en cadena de la [propiedad del dominio](/es/glossary/domain-ownership/)) convierte a los escépticos de una manera que un texto pulido nunca lo hará.
