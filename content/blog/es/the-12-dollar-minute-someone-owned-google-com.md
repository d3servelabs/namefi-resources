...
No irrumpió en nada. No explotó un desbordamiento de búfer ni realizó [phishing](/es/glossary/phishing/) a un administrador. Fue a la propia tienda de Google — Google Domains — escribió el dominio más famoso del mundo y vio cómo el proceso de compra hacía algo que nunca debería haber ocurrido: lo dejó pagar. Su tarjeta fue cargada. El pedido se completó. Y durante aproximadamente sesenta segundos, el titular del [registro](/es/glossary/registry/) de google.com era un estudiante de posgrado en Massachusetts.
