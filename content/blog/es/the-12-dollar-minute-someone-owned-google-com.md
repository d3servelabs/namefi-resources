...
Se supone que un dominio así es intocable. Debería estar bloqueado, marcado, retenido por el registro, en server-hold, con transferencia prohibida — envuelto en todas las protecciones que un registrador puede aplicar. La premisa misma de la seguridad de dominios es que cuanto más crítico es el nombre, más difícil es moverlo.
