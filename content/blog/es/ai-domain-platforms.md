...
- **Tu agente necesita realizar transacciones sin una cuenta preexistente de una persona, o quieres que el propio dominio sea un activo portátil en poder de una billetera.** Ese es el vacío para el que se creó [Namefi](https://namefi.io): pago con firma de billetera sin paso de registro, más la propiedad de un [Dominio Tokenizado](/es/glossary/tokenized-domain/) si quieres que el dominio se mueva y demuestre su custodia como cualquier otro activo on-chain.
