---
title: 'De del.icio.us a Delicious.com: El truco de dominio más ingenioso de la web — y por qué Yahoo lo desenredó'
date: '2026-06-17'
language: es
...
![Ilustración editorial vívida a todo color del truco de dominio del.icio.us: la cadena de puntos del punto icio punto us brillando en azul de etiqueta, con un punto que se desplaza para deletrear delicious, mientras variantes mal escritas flotan a su alrededor como fantasmas](../../assets/from-del-icio-us-to-delicious-com-02-domain-hack.jpg)
...
Yahoo ahora era propietaria de un producto que definía una categoría. También era propietaria del mayor problema de legibilidad de ese producto. Un proyecto personal sin presupuesto puede llevar un domain hack como insignia. Una propiedad de consumo masivo propiedad de una empresa pública que quiere que *todos* la usen no puede — cada punto es fricción que se interpone entre Yahoo y el crecimiento de [mercado](/es/glossary/marketplace/) masivo que justificó el precio de compra.
...
![Ilustración editorial vívida a todo color del rebranding: una cadena enredada del-punto-icio-punto-us que se endereza hasta convertirse en una etiqueta de marcador limpia de Delicious.com, con una barra de dirección de navegador antigua redirigiendo a una nueva y ordenada](../../assets/from-del-icio-us-to-delicious-com-01-the-move.jpg)
...
| Un domain hack (el ccTLD .us deletreando una palabra) | Una palabra [.com](/es/tld/com/) simple y de coincidencia exacta |
...
![Ilustración colorida de un dominio premium que pasa por una transferencia verificada, un token verde de Namefi y la continuidad del DNS](../../assets/from-del-icio-us-to-delicious-com-03-namefi-angle.jpg)
