...
3. Crea una cuenta con el [Registrador](/en/glossary/registrar/) al que te conduce el generador, si aún no tienes una.
...
8. Crea los registros [DNS](/en/glossary/dns/) que el sitio necesita: un registro A o CNAME para la aplicación, MX para el correo electrónico y TXT para la verificación y SPF.
...
| 5. Gestionar el ciclo de vida | Gestiona renovaciones, cambios de DNS y [transferencias](/en/glossary/transfer-lock/) durante años, sin volver a abrir un panel | Establecer la política una vez | La API de Namefi expone la [renovación automática](/en/glossary/domain-renewal/) como un interruptor que un agente puede activar el día del registro; la propia beta de Cloudflare, en cambio, indica que la [«gestión posterior al registro, incluidas las transferencias, renovaciones y actualizaciones de contacto, no está en la beta actual»](https://webhosting.today/2026/04/22/ai-agents-can-now-register-domains-no-human-required/) |
