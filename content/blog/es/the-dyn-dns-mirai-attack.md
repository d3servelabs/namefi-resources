...
Cada vez que escribes un nombre de dominio, tu computadora tiene que traducirlo a una dirección IP numérica antes de poder conectarse a cualquier cosa. Esa traducción es el trabajo del DNS, el Sistema de Nombres de Dominio. Es la capa de búsqueda entre el nombre legible para los humanos y la máquina a la que apunta.
...
1. **Un dominio tiene más puntos de fallo que su registrador.** El proveedor que responde "¿hacia dónde apunta este nombre?" es tan fundamental como los servidores detrás de él.
