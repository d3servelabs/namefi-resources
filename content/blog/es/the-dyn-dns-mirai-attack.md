...
Cada vez que escribes un nombre de dominio, tu computadora tiene que traducirlo a una dirección IP numérica antes de poder conectarse a cualquier cosa. Esa traducción es el trabajo del DNS, el [Sistema de Nombres de Dominio](/es/glossary/dns/). Es la capa de búsqueda entre el nombre legible para los humanos y la máquina a la que apunta.
