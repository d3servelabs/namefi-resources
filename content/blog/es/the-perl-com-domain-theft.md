...
Esta es la parte que convierte este incidente en un caso de manual y no en una nota al pie: nadie hackeó el servidor web de perl.com y nadie adivinó una contraseña de DNS. El ataque ocurrió un nivel más arriba, en el registrador — la empresa que mantiene el [registro](/es/glossary/registry/) autoritativo de quién posee el nombre.
