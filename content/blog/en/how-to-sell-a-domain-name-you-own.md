...
| Your constraints | Renewal costs, urgency, minimum acceptable price, and patience |
...
[Namefi Outbound](https://namefi.io/outbound) is built for the buyer-research part of the process.
...
If you are sending commercial email, follow the rules that apply to you. In the U.S., the [FTC's CAN-SPAM guide](https://www.ftc.gov/business-guidance/resources/can-spam-act-compliance-guide-business) covers requirements like accurate sender information, non-deceptive subject lines, a valid postal address, and a clear opt-out. Other countries can be stricter. "I am just selling one domain" is not a compliance strategy.
...
Be careful with scams. The [FTC](https://consumer.ftc.gov/articles/how-avoid-scam) warns that scammers often pressure people to act immediately, insist on specific payment methods, or send checks that later turn out to be fake. For domain sellers, the common patterns are familiar:
...
In the U.S., the IRS treats sales of assets under tax rules that depend on how the asset was held and used; [IRS Publication 544](https://www.irs.gov/publications/p544) is one starting point, not a substitute for a CPA. Other jurisdictions have their own rules.
...
If you are ready to research possible buyers for a domain you own or represent, start with [Namefi Outbound](https://namefi.io/outbound).
