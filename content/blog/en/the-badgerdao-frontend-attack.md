...
Security researchers call this pattern *ice [phishing](/en/glossary/phishing/)*: instead of stealing your [private key](/en/glossary/private-key/), you are tricked into voluntarily approving a malicious spender. The signature is real. The approval is real. The on-chain transaction is valid. That is exactly why it is so dangerous — and why no contract audit could have stopped it.
