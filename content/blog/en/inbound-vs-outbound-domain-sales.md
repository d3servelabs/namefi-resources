...
- **High margin.** A buyer who arrives on their own is usually an end user who already wants the name, which means they arrive willing to pay an end-user price rather than a reseller's wholesale number. The [end-user vs reseller spread](/en/blog/end-user-vs-reseller-domain-pricing/) is the entire reason inbound can be so profitable.
