...
relatedArticles:
  ...
  # TODO(link-when-published): /en/blog/nl-domain-purchase/ /en/blog/agents-buy-domains/ /en/blog/agent-own-domain/ /en/blog/ai-search-meanings/
relatedTopics:
...
- **You're not sure you need agentic purchase authority at all.** If what you actually want is help picking a name while a person still clicks "buy," you're better served by an AI-assisted name generator than any platform in this guide.<!-- link-when-published: /en/blog/ai-search-meanings/ -->
