...
The name was a workaround, not a choice. When [the idea for Box.com started in 2003 with Aaron Levie, a business student at the University of Southern California](https://en.wikipedia.org/wiki/Box_(company)#:~:text=The%20idea%20for%20Box.com%20started%20in%202003%20with%20Aaron%20Levie), the clean exact-match — Box.com — was already taken. So the company that would become [Box, Inc. (formerly Box.net)](https://en.wikipedia.org/wiki/Box_(company)#:~:text=Box%2C%20Inc.%20(formerly%20Box.net)) did what countless startups do when the .com is gone: it reached for the next-best TLD, launched on Box.net, and shipped.
