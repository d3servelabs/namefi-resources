...
- A **registered domain name**, whose treatment depends on jurisdiction, acquisition, use, and other facts. In the United States, [IRS Chief Counsel Advice 201543014](https://www.irs.gov/pub/irs-wd/201543014.pdf) analyzes certain secondary-market domains acquired for use in a trade or business as capitalized intangible assets and, when its stated conditions are met, amortizable Section 197 intangibles; it expressly does not cover domains acquired for resale or investment. Like other written determinations covered by Section 6110(k)(3), this CCA may not be used or cited as precedent.
- An [**NFT**](/en/glossary/nft/), which is much newer and which tax authorities may classify differently depending on the rights and assets involved. Pending further U.S. guidance, [IRS Notice 2023-27](https://www.irs.gov/pub/irs-drop/n-23-27.pdf) describes a look-through analysis for determining whether **certain** NFTs are Section 408(m) collectibles: an NFT is treated as a collectible when its associated right or asset is a collectible, and not when that associated right or asset is not a collectible.
