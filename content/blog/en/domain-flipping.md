...
Not every name that *looks* flippable is safe to flip. The single most important boundary in this business is the line between legitimate domaining and [cybersquatting](/en/glossary/cybersquatting/). Registering a generic dictionary word to resell is ordinary investing; registering something that trades on a specific company's [trademark](/en/glossary/trademark/) is a fast route to losing the name and possibly worse.
