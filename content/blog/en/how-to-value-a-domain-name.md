---
title: "How to Value a Domain Name: A Practical Appraisal Guide"
date: '2026-06-20'
language: en
...
**The extension.** `.com` is still the default the rest of the web is measured against. Wikipedia notes it [is short for *commercial*](https://en.wikipedia.org/wiki/.com#:~:text=it%20is%20short%20for%20commercial) and [has grown into the largest top-level domain](https://en.wikipedia.org/wiki/.com#:~:text=It%20has%20grown%20into%20the%20largest%20top%2Dlevel%20domain), with on the order of 160 million names registered. That ubiquity is exactly why a `.com` typically commands a premium over the identical name on another [TLD](/en/glossary/tld/) — it's the one people assume by default and type without thinking. Other extensions can be worth a great deal in the right context (a developer brand on [`.io`](/en/tld/io/), an AI company on [`.ai`](/en/tld/ai/), a startup hedging on [`.co`](/en/tld/co/)), but the spread between the `.com` and everything else is real money. We unpack the mechanics in [how the TLD affects domain value](/en/blog/how-tld-affects-domain-value/).
...
When you *do* cite a famous sale as an anchor, verify it before you lean on it. The headline numbers are easy to find and easy to get wrong. In February 2026, broker GetYourDomain.com announced the [$70 million sale of AI.com](https://www.prnewswire.com/news-releases/getyourdomaincom-brokers-the-70-million-sale-of-aicom-the-largest-domain-name-transaction-in-history-302682315.html); [AI.com's launch announcement](https://ai.com/company-news/ai-com-launch) says the domain was acquired in 2025 in a transaction believed to be the largest domain purchase in history. The previous public record was Voice.com: Wikipedia records its [2019 sale for $30,000,000](https://en.wikipedia.org/wiki/List_of_most_expensive_domain_names#:~:text=Voice.com), and CoinDesk reported [Block.One paying $30 million to seller MicroStrategy](https://www.coindesk.com/markets/2019/06/19/blockone-paid-30-million-for-a-domain#:~:text=Block.One%20paid%20%2430%20million%20for%20Voice.com). Earlier anchors include [Sex.com in 2010 for $13,000,000](https://en.wikipedia.org/wiki/List_of_most_expensive_domain_names#:~:text=Sex.com) and [Hotels.com in 2001 for $11,000,000](https://en.wikipedia.org/wiki/List_of_most_expensive_domain_names#:~:text=Hotels.com). These are outliers, not comps for a normal name — but they're the kind of figure that needs a source, not a memory.
...
**Ignoring renewal cost.** A domain isn't a one-time purchase — it's a subscription. Every name you hold costs money every year, and premium extensions or [registry](/en/glossary/registry/)-tiered names can carry steep renewals. A "great $500 flip" that costs $90 a year to hold and sits for five years isn't the win it looked like. Net the carry cost out of every appraisal.
