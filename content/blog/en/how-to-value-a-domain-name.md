...
When you *do* cite a famous sale as an anchor, verify it before you lean on it. The headline numbers are easy to find and easy to get wrong. The verified high-water mark for a publicly disclosed sale is Voice.com: as Wikipedia's list records, it [sold in 2019 for $30,000,000](https://en.wikipedia.org/wiki/List_of_most_expensive_domain_names#:~:text=Voice.com), a deal [CoinDesk reported as Block.One paying $30 million for Voice.com](https://www.coindesk.com/markets/2019/06/19/blockone-paid-30-million-for-a-domain#:~:text=Block.One%20paid%20%2430%20million%20for%20Voice.com) (the buyer) after MicroStrategy (the seller). Earlier anchors on the same list include [Sex.com in 2010 for $13,000,000](https://en.wikipedia.org/wiki/List_of_most_expensive_domain_names#:~:text=Sex.com) and [Hotels.com in 2001 for $11,000,000](https://en.wikipedia.org/wiki/List_of_most_expensive_domain_names#:~:text=Hotels.com). These are outliers, not comps for a normal name — but they're the kind of figure that needs a source, not a memory.
