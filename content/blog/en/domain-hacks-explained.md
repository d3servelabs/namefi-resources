...
3. **What's the registry's policy and stability?** Before you value a `.ly`, `.io`, or any ccTLD hack, learn whether the registry welcomes third-party registration, what content rules apply, and how politically stable the territory is. This is the diligence the vb.ly [registrant](/en/glossary/registrant/) didn't get to do. A beautiful hack on a volatile or restrictive ccTLD carries a discount a `.com` never would.
