...
That gap is the most important line in this business, and it is the one most easily crossed by accident. This guide walks the boundary: what cybersquatting actually is, the three-part conjunctive test the UDRP uses to claw back a name, how the U.S. [ACPA](/en/glossary/acpa/) adds money damages, and the flip side most articles skip, reverse domain name hijacking, where a brand abuses the system against a legitimate owner. It is the legal-risk companion to our pillar on [domain flipping and the law](/en/blog/domain-flipping-and-the-law/) and the [domain flipping](/en/blog/domain-flipping/) series hub.
...
Cybersquatting is not "registering a name someone else wants." It is registering a name to exploit someone else's [trademark](/en/glossary/trademark/). Wikipedia's definition is the one to internalize: it is [the practice of registering, trafficking in, or using an Internet domain name, with a bad faith intent to profit from the goodwill of a trademark belonging to someone else](https://en.wikipedia.org/wiki/Cybersquatting#:~:text=is%20the%20practice%20of%20registering%2C%20trafficking%20in%2C%20or%20using%20an%20Internet%20domain%20name%2C%20with%20a%20bad%20faith%20intent%20to%20profit). Every word in that sentence is load-bearing. The conduct (register, traffic, use) is broad. The intent ([bad faith](/en/glossary/bad-faith/), to profit) is the trigger. And the target is specific: a *trademark belonging to someone else*, not a generic word the whole market shares.
