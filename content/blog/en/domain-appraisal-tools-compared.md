...
4. **Layer in the extension's real behavior.** A model scores the letters; it doesn't always price the *durability* of a ccTLD whose registry can restrict or whose country status is in flux. [How the TLD affects value](/en/blog/how-tld-affects-domain-value/) is a fundamental, not a footnote.
