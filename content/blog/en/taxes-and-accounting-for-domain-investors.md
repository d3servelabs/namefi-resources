...
For a hand-registered name, that's straightforward: the [registrar](/en/glossary/registrar/) registration fee. For a name you bought on the [aftermarket](/en/glossary/marketplace/), it's the purchase price, and you'll want to think about associated acquisition costs like [escrow](/en/glossary/escrow/) fees, broker commissions, or [auction](/en/glossary/auction/) premiums. Whether each of those gets added to basis or expensed is exactly the kind of thing to confirm with a professional, because the answer can depend on whether you're an investor or a dealer.
