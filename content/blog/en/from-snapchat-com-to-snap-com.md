---
title: 'From Snapchat.com to Snap.com: The $5M Domain That Turned an App Into a Camera Company'
date: '2026-06-16'
language: en
...
So the company did two things, years apart, that fit together. First, quietly, it bought the exact-match **Snap.com** — a domain it didn't yet have a public use for. Then, in September 2016, it changed its corporate name and let that [short domain](/en/glossary/short-domain/) become the front door to a new identity. When [the company behind Snapchat changed its name from Snapchat Inc. to just Snap Inc.](https://m.gsmarena.com/snapchat_changes_company_name_to_snap_inc_announces_spectacles-blog-20696.php#:~:text=the%20company%20behind%20Snapchat%20is%20changing%20its%20name%20from%20Snapchat%20Inc.%20to%20just%20Snap%20Inc.), the domain it needed was already paid for.

The reported price for that domain — discovered later in an SEC filing, never officially confirmed — was **[$5 million](https://www.thedomains.com/2017/02/02/snap-pay-5million-snap-com/#:~:text=There%20is%20a%20%245%20million%20number%20for%20domain%20names)**.
...
The rebrand was not a single tweak. The Drum described [a sweeping rebrand that saw web domains and social media counts renamed as Snap Inc](https://www.thedrum.com/news/2016/09/24/snapchat-rebrands-snap-inc-after-camera-spectacles-unveil#:~:text=a%20sweeping%20rebrand%20that%20saw%20web%20domains%20and%20social%20media%20counts%20renamed%20as%20Snap%20Inc). And the explicit logic for the new name was that the old one was now too small. Evan Spiegel's reasoning was that [now that we are developing other products, like Spectacles, we need a name that goes beyond just one product](https://www.thedrum.com/news/2016/09/24/snapchat-rebrands-snap-inc-after-camera-spectacles-unveil#:~:text=Now%20that%20we%20are%20developing%20other%20products%2C%20like%20Spectacles%2C%20we%20need%20a%20name%20that%20goes%20beyond%20just%20one%20product).

That is the entire thesis of a domain upgrade compressed into one sentence: *a name that goes beyond just one product*. The app stayed Snapchat. The company became Snap. And the new corporate identity needed the short, exact-match address to stand on. The Snap Inc. homepage promptly [bills itself as a camera company](https://www.itsnicethat.com/news/snapchat-renamed-snap-inc-launches-spectacles-sunglasses-260916#:~:text=The%20Snap%20Inc.%20homepage%20bills%20itself%20as%20a%20camera%20company) — a description that would have looked absurd on a domain called Snapchat.com.
...
| Names one app | Names a company without a ceiling |
| Means "messaging / disappearing chat" | Travels across app, hardware, and AR |
| Reads like a product | Reads like a parent brand |
...
Then in September 2016 the public story arrived. The reveal of Spectacles became the occasion to rename the company, and [the new product was unveiled on September 24, 2016, and released on November 10, 2016](https://en.wikipedia.org/wiki/Spectacles_%28product%29#:~:text=The%20new%20product%20was%20unveiled%20on%20September%2024%2C%202016%2C%20and%20released%20on%20November%2010%2C%202016). The hardware needed a company name that wasn't an app name, and the company name needed an [exact-match domain](/en/glossary/exact-match-domain/) that wasn't an app domain.
