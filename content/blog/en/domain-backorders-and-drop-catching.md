...
**Watch the trademark line.** Catching an expired name doesn't launder its history. If the string is somebody's brand, the fact that it lapsed doesn't make it safe to grab and resell. The [UDRP](/en/glossary/udrp/) framework still applies, and an expired trademarked name is exactly the kind of thing that triggers a dispute, as we cover in [what is UDRP](/en/blog/what-is-udrp/). Catch generic and brandable names, not lapsed brands.
