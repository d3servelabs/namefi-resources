...
Stack those up and you have a worst-case kit. Admin password gets you into the site. sFTP and database access let you alter it at the file and data layer. And the SSL [private key](/en/glossary/private-key/) — as Wordfence noted in its [analysis of the breach](https://www.wordfence.com/blog/2021/11/godaddy-breach-plaintext-passwords/) — could let an attacker impersonate a site or decrypt its traffic. A registrar that is supposed to anchor trust had instead handed an intruder the materials to forge it.
