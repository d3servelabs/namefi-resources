...
This article explains what HTTPS actually does, and walks through the concepts it is built from: encryption, ports, certificates, certificate authorities, and the ACME protocol that now issues most of the world's certificates automatically. It ends where every HTTPS chain ends if you follow it far enough down: at control of a domain name.
...
- CA/Browser Forum — [Ballot SC-081v3: Introduce Schedule of Reducing Validity and Data Reuse Periods](https://cabforum.org/2025/04/11/ballot-sc081v3-introduce-schedule-of-reducing-validity-and-data-reuse-periods/) (April 2025).
