...
Start with the thing that makes [domaining](/en/glossary/domaining/) different from buying baseball cards or art: you never own a domain outright. You hold it for a registration term and you keep it only by paying to renew. Miss the renewal and the name leaves your control on a fixed schedule.
...
Two forces push that number up over time, and both work against you. First, the wholesale price under your retail price keeps climbing. When Verisign announced its 2024 increase, the [registry](/en/glossary/registry/) [currently charges registrars $9.59 per year for .com registrations. That will increase to $10.26](https://domainnamewire.com/2024/02/08/verisign-announces-com-price-hike-to-10-26/#:~:text=charges%20registrars%20%249.59%20per%20year%20for%20.com%20registrations.%20That%20will%20increase%20to%20%2410.26), and under the registry contract Verisign [is allowed to increase prices by 7% in each of the last four years](https://domainnamewire.com/2024/02/08/verisign-announces-com-price-hike-to-10-26/#:~:text=is%20allowed%20to%20increase%20prices%20by%207%25%20in%20each%20of%20the%20last%20four%20years) of its term. A compounding 7% means the floor under your renewal bill ratchets upward whether or not any of your names appreciate. Second, the bill grows every time you acquire faster than you sell — and most investors acquire faster than they sell, because buying is the fun part.

Extension choice changes the picture, too. The conventional `.com` floor is one thing; a [premium extension](/en/tld/io/) like [`.io`](/en/blog/why-are-io-domains-expensive/) or [`.ai`](/en/tld/ai/) often renews for many times that, while a discount [`.xyz`](/en/tld/xyz/) may renew cheaply but resell rarely. A portfolio of expensive-to-renew extensions needs a correspondingly higher sale rate just to break even. The [registrar](/en/glossary/registrar/) you choose matters at the margin as well, since renewal pricing is where registrars quietly differ most.
...
The arithmetic is unforgiving but simple. If your portfolio sells 1% to 2% of its names in a year, you are paying renewals on 98% to 99% of a book that produced no revenue. The model survives only because the *price* of a sale is wildly out of scale with the cost of a renewal. One name that resells for $2,000 covers the annual renewal on roughly two hundred `.com`s at the low end of that retail range. A single four- or five-figure sale can carry a large portfolio for a year or more — which is precisely why the trade works at all.
