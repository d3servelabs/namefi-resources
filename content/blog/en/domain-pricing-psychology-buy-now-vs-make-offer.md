---
title: "Domain Pricing Psychology: Buy-Now vs Make-Offer"
date: '2026-06-21'
language: en
...
The shape of the number sends a message of its own. This is the domain of psychological pricing, which Wikipedia describes as a strategy [based on the theory that certain prices have a psychological impact](https://en.wikipedia.org/wiki/Psychological_pricing#:~:text=based%20on%20the%20theory%20that%20certain%20prices%20have%20a%20psychological%20impact). The classic finding is that buyers perceive [just-below prices (also referred to as "odd prices") as being lower than they are](https://en.wikipedia.org/wiki/Psychological_pricing#:~:text=just%2Dbelow%20prices%20%28also%20referred%20to%20as%20%22odd%20prices%22%29%20as%20being%20lower%20than%20they%20are) — the reason retail runs on $9.99, driven by what researchers named the [left-digit effect](https://en.wikipedia.org/wiki/Psychological_pricing#:~:text=left%2Ddigit%20effect).
