...
यह पहली बात है जो 9 अगस्त, 2022 को Curve Finance के साथ हुई घटना को समझने के लिए ज़रूरी है, और यही वह पहलू है जो सुरक्षा इंजीनियरों को वर्षों बाद भी बेचैन करता है। Curve का [ऑन-चेन](/hi/glossary/on-chain/) कोड — ऑडिटेड, युद्ध-परीक्षित ऑटोमेटेड मार्केट मेकर जो अरबों स्टेबलकॉइन्स संभाल रहा था — कभी छुआ ही नहीं गया। कोई reentrancy बग नहीं। कोई oracle manipulation नहीं। कोई flash-loan exploit नहीं। [ब्लॉकचेन](/hi/glossary/blockchain/) ने वही किया जो उसे करना था।
...
4. **एक साफ fallback रखें।** Curve की बचाने वाली बात थी अलग इन्फ्रास्ट्रक्चर पर `curve.exchange`। एक दूसरा फ्रंट-एंड पाथ — एक अलग डोमेन, एक अलग DNS provider, [IPFS](/hi/glossary/ipfs/) या [ENS](/hi/glossary/ens/)-आधारित mirror — आपको कहीं ऐसी जगह देता है जहां उपयोगकर्ताओं को भेज सकें जब आपका प्राथमिक नाम poisoned हो।
