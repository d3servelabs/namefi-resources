...
ज़्यादातर बड़े संगठन **स्प्लिट-होराइज़न DNS (split-horizon DNS)** का इस्तेमाल करते हैं। इसमें एक ही नाम (`vpn.example.corp`, `git.example.com`, `intranet.example.com`) अलग-अलग [IP एड्रेस](/hi/glossary/ip-address/) में रिज़ॉल्व होता है, जो इस बात पर निर्भर करता है कि क्वेरी नेटवर्क के अंदर से आ रही है या बाहर से।
...
- `git.example.com` पब्लिक लोड बै[लेंस](/hi/glossary/lens/)र में रिज़ॉल्व होता है।
