...
![एक प्रूवर निजी विटनेस को अपने पीछे बंद रखते हुए वेरिफ़ायर को चमकता हुआ वैध-प्रूफ़ बैज देता है; यह दिखाता है कि ज़ीरो-नॉलेज प्रूफ़ गुप्त जानकारी उजागर किए बिना सार्वजनिक कथन को सत्यापित करता है](../../assets/blockchain-privacy-technologies-01-zero-knowledge.jpg)

[ज़ीरो-नॉलेज प्रूफ़](/hi/glossary/zero-knowledge-proof/) (ZKP) एक पक्ष—*प्रूवर*—को दूसरे पक्ष—*वेरिफ़ायर*—के सामने यह साबित करने देता है कि कोई सार्वजनिक कथन सही है, जबकि उसे साबित करने में इस्तेमाल हुई निजी *विटनेस* उजागर नहीं होती; वेरिफ़ायर को सार्वजनिक कथन और उसके सत्य होने से स्वाभाविक रूप से निष्कर्षित जानकारी के अलावा कुछ अतिरिक्त नहीं मिलता। “मैं ऐसे `x` को जानता हूँ जिसके लिए `H(x) = y` है” जैसे दावे में वेरिफ़ायर सामान्यतः कथन और सार्वजनिक मान `y` देखता है; ज़ीरो-नॉलेज `x` की रक्षा करता है। अनुप्रयोग अपने सार्वजनिक इनपुट के कुछ हिस्सों को अलग से छिपा सकते हैं या उन पर commitment लगा सकते हैं, लेकिन कथन को स्वयं छिपाना ZKP की सामान्य परिभाषा का हिस्सा नहीं है ([Thaler, *Proofs, Arguments, and Zero-Knowledge*](https://people.cs.georgetown.edu/jthaler/ProofsArgsAndZK.html))।

किसी प्रूफ़ सिस्टम को वास्तविक ज़ीरो-नॉलेज प्रोटोकॉल माने जाने के लिए तीन गुण पूरे करने होते हैं: completeness (ईमानदार वेरिफ़ायर सही दावे को स्वीकार करता है), soundness (बेईमान प्रूवर केवल प्रूफ़ सिस्टम की सीमित error probability के भीतर ही ईमानदार वेरिफ़ायर से ग़लत दावा स्वीकार करा सकता है), और स्वयं zero-knowledge (प्रूफ़ सार्वजनिक कथन से निकलने वाली बातों के अलावा निजी विटनेस के बारे में कोई अतिरिक्त जानकारी उजागर नहीं करता)। शास्त्रीय interactive protocol में प्रायः commitment, verifier challenge और prover response का क्रम होता है। आधुनिक non-interactive SNARK और STARK वेरिफ़ायर से live challenge लिए बिना आवश्यक proof data को एक साथ पैक करते हैं, जबकि completeness, soundness और zero-knowledge के वही व्यापक लक्ष्य बनाए रखते हैं।

**यह क्या छिपाता है:** निजी विटनेस, जैसे गोपनीय डेटा या निजी संगणना के इनपुट। सार्वजनिक कथन और सार्वजनिक इनपुट दिखाई देते रहते हैं, जब तक अनुप्रयोग उन्हें अलग से किसी commitment से न बाँधे या एन्क्रिप्ट न करे।
...
**समझौता:** ZK प्रूफ़ बनाना संगणना के लिहाज़ से महँगा है—प्रूविंग सर्किट बैच के हर ट्रांज़ैक्शन से गुज़रते हैं और उसकी जाँच दोबारा चलाते हैं—इसलिए प्रूविंग में लगने वाला समय और हार्डवेयर की लागत वास्तविक सीमाएँ हैं, भले ही ऑनचेन सत्यापन सस्ता और तेज़ हो। इसकी सुरक्षा प्रूफ़ सिस्टम की cryptographic assumptions, सुरक्षित parameter generation, और circuit व protocol के सही implementation पर टिकी है; कुछ प्रूफ़ सिस्टम में एक बार होने वाला trusted setup समारोह भी इसका हिस्सा है। Ethereum का दस्तावेज़ बताता है कि setup entropy के compromised होने से ग़लत प्रूफ़ बनाना संभव हो सकता है और implementation की त्रुटियाँ security model को कमज़ोर कर सकती हैं ([ethereum.org](https://ethereum.org/en/zero-knowledge-proofs/#trust-assumptions))।
...
|---|---|---|---|---|---|
| ज़ीरो-नॉलेज प्रूफ़ | निजी विटनेस/डेटा; सार्वजनिक कथन दिखाई देता है, जब तक उसे अलग से न छिपाया जाए | प्रूफ़ सिस्टम की assumptions, parameters और circuit/protocol implementation; कुछ सिस्टम में trusted setup | प्रूफ़ बनाना महँगा; सत्यापन सस्ता | बड़े पैमाने पर प्रोडक्शन में (rollup, shielded payment) | zkSync, Starknet, Zcash |
...
- [प्रूफ़, आर्ग्युमेंट और ज़ीरो-नॉलेज — Justin Thaler](https://people.cs.georgetown.edu/jthaler/ProofsArgsAndZK.html)
