...
- **रजिस्ट्री लॉक (Registry lock)** (रजिस्ट्रार लॉक से अलग), जहाँ रजिस्ट्री ऑपरेटर स्वयं आउट-ऑफ़-बैंड कन्फर्मेशन (out-of-band confirmation) के बिना ट्रांसफर या संपर्क विवरण बदलने से इनकार कर देता है। यह `.com`, `.net`, और कई ccTLDs पर उपलब्ध है।
