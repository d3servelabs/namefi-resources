...
संक्षिप्त उत्तर: **हाँ, हाँ, नहीं।** एक [टोकनाइज़्ड डोमेन](/hi/glossary/tokenized-domain/) अभी भी एक असली ICANN डोमेन है। DNS ठीक वही करता रहता है जो DNS करता है। यह पोस्ट इस बात का दौरा है कि क्या बदलता है (थोड़ा सा) और क्या नहीं (ज्यादातर चीजें)।
...
1. **[DNS](/hi/glossary/dns/) / [रजिस्ट्री](/hi/glossary/registry/) लेयर** — वही जिसमें आपका `.com` हमेशा से मौजूद है। [ICANN](/hi/glossary/icann/), [रजिस्ट्रार](/hi/glossary/registrar/), [रूट सर्वर](/hi/glossary/root-zone/), [रिकर्सिव रिज़ॉल्वर](/hi/glossary/dns-resolver/)।
2. **[ऑन-चेन](/hi/glossary/on-chain/) लेयर** — आपके [वॉलेट](/hi/glossary/wallet/) में एक [NFT](/hi/glossary/nft/) जो *स्वामित्व* (ownership) को दर्शाता है।

DNS रिज़ॉल्यूशन — `example.com` को [IP एड्रेस](/hi/glossary/ip-address/) में बदलना — पूरी तरह से लेयर 1 पर होता है। ऑन-चेन लेयर इस बारे में है कि **डोमेन को कौन नियंत्रित करता है**, न कि यह कैसे रिज़ॉल्व होता है। ब्राउज़र, ईमेल सर्वर, CDN और सर्टिफ़िकेट अथॉरिटीज़ को कभी यह जानने की आवश्यकता नहीं होती कि [ब्लॉकचेन](/hi/glossary/blockchain/) मौजूद है।
...
आप अभी भी अपने डोमेन के लिए [नेमसर्वर](/hi/glossary/nameserver/) सेट करते हैं। Cloudflare, Route53, Namecheap, Google Cloud DNS, dnsimple का उपयोग करें — जो भी आपने पहले उपयोग किया था वह ठीक है। बहुत से लोग अपने DNS प्रदाता को वहीं छोड़ देते हैं जहाँ वह टोकनाइज़ करते समय था और उसे फिर कभी नहीं छूते।
...
आपको अभी भी उन्हीं से सर्टिफ़िकेट मिलते हैं जिनसे आपको पहले मिलते थे। Let's Encrypt, आपका CDN प्रदाता, आपका लोड बै[लेंस](/hi/glossary/lens/)र — प्रक्रिया (flow) वही है। ACME चुनौतियां (DNS-01 या HTTP-01) भी उसी तरह काम करती हैं।
...
यही मुख्य बिंदु है। यही कारण भी है कि आपको वॉलेट सुरक्षा को गंभीरता से लेने की आवश्यकता है — देखें [वॉलेट खोने के बाद टोकनाइज़्ड डोमेन को रिकवर करना](/hi/blog/recovering-a-tokenized-domain-after-wallet-loss/)।
...
पहले: [क्रॉस-रजिस्ट्रार ट्रांसफर](/hi/glossary/cross-registrar-transfer/) प्रक्रिया, जिसमें [ऑथ कोड (auth codes)](/hi/glossary/auth-code/) और 60-दिन का कूलडाउन होता है।
बाद में: [**NFT ट्रांसफर करें**](/hi/glossary/atomic-transfer/)। एक सिंगल ऑन-चेन ट्रांज़ैक्शन से स्वामित्व बदल जाता है। रजिस्ट्रार-साइड रिकॉर्ड को प्रोटोकॉल द्वारा सिंक में रखा जाता है। यह नाटकीय रूप से तेज़ है — और यही कारण है कि टोकनाइज़्ड-डोमेन मार्केटप्लेस को पारंपरिक [एस्क्रो (escrow)](/hi/glossary/escrow/) की आवश्यकता नहीं होती है (देखें [लिस्टिंग से सेटलमेंट तक](/hi/blog/how-tokenized-marketplaces-replace-escrow/))।
...
- **एक ही समय में नेमसर्वर और DNS प्रदाता बदलना।** यह आकर्षक लगता है, लेकिन अनावश्यक जोखिम पैदा करता है। पहले [टोकनाइज़ करें](/hi/glossary/tokenize/), फिर यदि आप चाहें तो बाद में DNS प्रदाता बदलें।
...
पहली बार में टोकनाइज़ करने के ऑपरेटर-स्तर के वॉकथ्रू के लिए, [अपना .com कैसे टोकनाइज़ करें](/hi/blog/how-to-tokenize-your-com/) देखें।