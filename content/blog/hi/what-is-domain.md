...
*   **[टॉप-लेवल डोमेन](/hi/glossary/tld/) (TLD):** यह एड्रेस के अंत में लगने वाला प्रत्यय है, जैसे `.com`, `.org`, `.net`, या हाल ही में, `.xyz`, `.app`, और यहाँ तक कि `.ninja`। कुछ जेनेरिक होते हैं (gTLDs), जबकि अन्य देश-विशिष्ट होते हैं (ccTLDs, जैसे `.us`, `.uk`, या `.cn`)।
*   **[सेकंड-लेवल डोमेन](/hi/glossary/second-level-domain/) (SLD):** यह नाम का मुख्य भाग है — `google.com` में `google`।
*   **[सबडोमेन](/hi/glossary/subdomain/):** ये वैकल्पिक उपसर्ग हैं जो सामग्री को व्यवस्थित करने में मदद करते हैं, जैसे `blog.example.com` या `mail.example.org`।
...
डोमेन नेम का वैश्विक समन्वय **ICANN** (**Internet Corporation for Assigned Names and Numbers**) नामक एक गैर-लाभकारी संगठन द्वारा देखा जाता है। 1998 में स्थापित, ICANN डोमेन नेम और IP एड्रेस के आवंटन का प्रबंधन करता है। यह [रजिस्ट्रार](/hi/glossary/registrar/) (जैसे GoDaddy, Namecheap, और Namefi) के साथ काम करता है जो जनता को डोमेन नेम बेचते हैं।
...
अन्य रजिस्ट्रारों की तुलना में, [Namefi](https://namefi.io/hi) सबडोमेन मैनेजमेंट, DNS सुरक्षा उपकरण, और [ब्लॉकचेन](/hi/glossary/blockchain/) डोमेन जैसे विकेंद्रीकृत प्रणालियों के साथ एकीकरण जैसी उन्नत सुविधाएँ प्रदान करता है।
...
*   **[सर्च इंजन ऑप्टिमाइजेशन](/hi/glossary/seo/)** (SEO)।
