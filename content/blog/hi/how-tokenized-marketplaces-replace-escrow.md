...
3. [Escrow.com](https://www.escrow.com/) या किसी समान प्लेटफ़ॉर्म पर एक [एस्क्रो (escrow)](/en/glossary/escrow/) खोलें। खरीदार फंड वायर करता है।
4. विक्रेता डोमेन को अनलॉक करता है और [ऑथ कोड (auth code)](/en/glossary/auth-code/) प्रदान करता है।
5. खरीदार अपने [रजिस्ट्रार (registrar)](/en/glossary/registrar/) पर [क्रॉस-रजिस्ट्रार ट्रांसफर](/en/glossary/cross-registrar-transfer/) शुरू करता है।
6. [ICANN](/en/glossary/icann/) ट्रांसफर के पूरा होने के लिए 5–7 दिन का इंतज़ार करें।
...
1. [टोकेनाइज़्ड डोमेन](/en/blog/what-are-tokenized-domains/) को किसी [मार्केटप्लेस](/en/glossary/marketplace/) पर लिस्ट करें (Namefi का अपना मार्केटप्लेस, Doma, [OpenSea](https://opensea.io/), [Blur](https://blur.io/), आदि)।
2. खरीदार भुगतान करता है। [NFT](/en/glossary/nft/) खरीदार के [वॉलेट](/en/glossary/wallet/) में चला जाता है। [रजिस्ट्रार](/en/glossary/registrar/) के साइड का रिकॉर्ड प्लेटफ़ॉर्म द्वारा सिंक (sync) रखा जाता है।
3. काम हो गया।

बस इतना ही। दो कदम। कोई [ऑथ कोड](/en/glossary/auth-code/) नहीं, कोई [एस्क्रो](/en/glossary/escrow/) नहीं, 5-दिन का कोई रजिस्ट्रार लॉक नहीं, और "मैंने पैसे भेज दिए हैं, अब मुझे तुम पर भरोसा करना होगा" वाला कोई गैप नहीं।

यह इसलिए काम करता है क्योंकि **NFT ही ओनरशिप (स्वामित्व) का प्रामाणिक रिकॉर्ड है**, और [ऑन-चेन](/en/glossary/on-chain/) ट्रांज़ैक्शन [एटॉमिक (atomic)](/en/glossary/atomic-transfer/) होते हैं: भुगतान और एसेट का ट्रांसफर एक ही ब्लॉक में होते हैं, या फिर दोनों में से कुछ नहीं होता।
...
**इसकी जगह क्रिप्टो और [स्टेबलकॉइन (stablecoin)](/en/glossary/stablecoin/) भुगतान ने ले ली है।** USDC, ETH और अन्य ऑन-चेन भुगतान कुछ ही सेकंड में सेटल हो जाते हैं। वायर ट्रांसफर सेटल होने में कई दिन लगते हैं। अंतरराष्ट्रीय बिक्री के मामले में यह अंतर सबसे ज़्यादा साफ़ दिखाई देता है।
...
क्रिप्टो में भुगतान की गई बिक्री, कुछ अधिकार क्षेत्रों में फिएट (fiat) मुद्रा में भुगतान की गई बिक्री से एक अलग टैक्स इवेंट मानी जाती है। अपने CPA (चार्टर्ड अकाउंटेंट) से पूछने लायक सवालों की सूची के लिए [टोकेनाइज़्ड डोमेन के लिए टैक्स और अकाउंटिंग से जुड़े सवाल पोस्ट](/en/blog/tax-and-accounting-questions-for-tokenized-domains/) देखें।
...
अगर आप वास्तव में किसी टोकेनाइज़्ड डोमेन को बेचने की कोशिश करना चाहते हैं, तो [namefi.io](https://namefi.io) पर जाएँ। व्यापक दृष्टिकोण (broader picture) के लिए, [2026 में टोकेनाइज़्ड डोमेन के उपयोग के मामले (Use Cases)](/en/blog/tokenized-domain-use-cases-2026/) देखें।