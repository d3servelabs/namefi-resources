...
अच्छी खबर: क्रिप्टोग्राफ़िक लेयर के अलावा **प्लेटफ़ॉर्म-लेवल पर रिकवरी के तरीके मौजूद हैं**। [टोकनाइज़्ड डोमेन](/hi/glossary/tokenized-domain/) का एक ऑफ़-चेन साइड (रजिस्ट्रार / DNS रिकॉर्ड) होता है जिसका उपयोग प्लेटफ़ॉर्म कभी-कभी स्थिति के आधार पर मदद के लिए कर सकते हैं।
...
2. **[ऑन-चेन](/hi/glossary/on-chain/) मूवमेंट को ट्रैक करें।** ब्लॉक एक्सप्लोरर दिखाएंगे कि NFT कहाँ गया। यह सबूत है।
3. **प्लेटफ़ॉर्म को सूचित करें।** वे अपनी तरफ़ से एड्रेस को फ़्लैग कर सकते हैं, रजिस्ट्रार-लेवल के अपडेट को रोक सकते हैं, या डीलिस्ट (delist) करने के लिए [मार्केटप्लेस](/hi/glossary/marketplace/) के साथ समन्वय (कोऑर्डिनेट) कर सकते हैं।
