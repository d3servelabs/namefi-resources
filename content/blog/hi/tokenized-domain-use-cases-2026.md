...
**यह क्या है:** एक सिंगल [ऑन-चेन](/hi/glossary/on-chain/) ट्रांज़ैक्शन साइन करके डोमेन बेचें। खरीदार भुगतान करता है, [NFT](/hi/glossary/nft/) ट्रांसफर होता है, [रजिस्ट्रार](/hi/glossary/registrar/) रिकॉर्ड अपडेट होता है, और यह सब [ऑटोमिक तरीके से (atomically)](/hi/glossary/atomic-transfer/) होता है। कोई [एस्क्रो (escrow)](/hi/glossary/escrow/) सेवा नहीं, कोई [ऑथ कोड (auth code)](/en/glossary/auth-code/) नहीं, कोई 5-दिन का रजिस्ट्रार लॉक नहीं।
...
**यह क्या है:** एक प्रीमियम डोमेन के स्वामित्व को कई धारकों के बीच विभाजित करना, जिनमें से प्रत्येक के पास [आंशिक शेयर (fractional shares)](/hi/glossary/fractional-ownership/) होते हैं।
...
**यह क्या है:** एक [AI एजेंट](/en/glossary/ai-agent/) (उपयोगकर्ता की ओर से कार्य करने वाला सॉफ़्टवेयर का एक हिस्सा) एक [वॉलेट](/hi/glossary/wallet/) रखता है, और उस वॉलेट में एक टोकनाइज़्ड डोमेन होता है। डोमेन एजेंट की पहचान बन जाता है — एड्रेसेबल, वेरिफ़ायबल और मोनेटाइज़ेबल (मुद्रीकरण योग्य)।
...
**यह क्या है:** अपने टोकनाइज़्ड डोमेन को [OpenSea](https://opensea.io/), [Blur](https://blur.io/), [Magic Eden](https://magiceden.io/), या प्लेटफ़ॉर्म-विशिष्ट [मार्केटप्लेस](/hi/glossary/marketplace/) पर सूचीबद्ध करें — किसी भी [ERC-721](/en/glossary/erc-721/) NFT को सूचीबद्ध करने जैसा ही UX (यूज़र एक्सपीरियंस)।
