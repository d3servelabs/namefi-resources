...
यदि आप विशेष रूप से [टोकनाइज़्ड डोमेन](/hi/glossary/tokenized-domain/) के बारे में विस्तार से जानना चाहते हैं, तो [What Are Tokenized Domains? (टोकनाइज़्ड डोमेन क्या हैं?)](/hi/blog/what-are-tokenized-domains/) से शुरुआत करें।

---

## एक लाइन में जवाब (The One-Liner)

- **टोकनाइज़्ड डोमेन (Tokenized domain)** = एक असली [ICANN](/hi/glossary/icann/) डोमेन (`.com`, `.xyz`, `.io`, आदि) जिसके ऊपर एक [ऑन-चेन](/hi/glossary/on-chain/) ओनरशिप टोकन जुड़ा होता है।
- [**वेब3 (Web3)**](/hi/glossary/web3/) **डोमेन** = एक ऐसा नाम जो **केवल** ऑन-चेन मौजूद होता है (`.eth`, `.crypto`, `.x`, आदि)। यह एक अलग नेमिंग सिस्टम है, [DNS](/hi/glossary/dns/) का हिस्सा नहीं है।
...
दोनों में [वॉलेट](/hi/glossary/wallet/) में NFT शामिल होते हैं। दोनों को "डोमेन" कहा जाता है। दोनों की बातचीत में कहीं न कहीं ICANN का ज़िक्र होता है — लेकिन एकदम विपरीत तरीके से। दोनों कैटेगरी की मार्केटिंग अक्सर इस अंतर को धुंधला कर देती है।
...
| [रजिस्ट्रार](/hi/glossary/registrar/) के पास सालाना रिन्यूअल | हाँ (असली DNS डोमेन) | आमतौर पर वन-टाइम या अलग मॉडल |
...
- आप चाहते हैं कि डोमेन एक सामान्य वेबसाइट के रूप में काम करते हुए भी [DeFi](/hi/glossary/defi/) में ऑन-चेन कोलैटरल (गिरवी) के रूप में इस्तेमाल किया जा सके।
...
आप `example.com` टाइप करते हैं। आपका कंप्यूटर [DNS रिज़ॉल्वर](/hi/glossary/dns-resolver/) से पूछता है। रिज़ॉल्वर DNS पदानुक्रम (hierarchy) में जाता है। आपको एक [IP एड्रेस](/hi/glossary/ip-address/) मिलता है। ब्राउज़र साइट को फेच करता है। यह सब वैसे ही काम करता है चाहे डोमेन टोकनाइज़्ड हो या नहीं, क्योंकि टोकनाइज़ेशन एक *ओनरशिप (स्वामित्व)* लेयर जोड़ता है, न कि *रिज़ॉल्यूशन* लेयर।

इस पहलू पर व्यावहारिक जानकारी के लिए [DNS Still Works (DNS अभी भी काम करता है)](/hi/blog/dns-on-tokenized-domains/) देखें।

### ENS / Web3-नेम रिज़ॉल्यूशन

आप `vitalik.eth` टाइप करते हैं। एक Web3-अवेयर क्लाइंट (MetaMask, कोई डैप, या [ENS](/hi/glossary/ens/) सपोर्ट वाले कुछ खास ब्राउज़र) एथेरियम पर ENS [स्मार्ट कॉन्ट्रैक्ट](/hi/glossary/smart-contract/) को क्वेरी करता है, जुड़ा हुआ एड्रेस या कंटेंट हैश प्राप्त करता है, और उसके अनुसार पेज रेंडर करता है। एक नॉन-Web3-अवेयर क्लाइंट (बिना एक्सटेंशन वाला Chrome, आपके ऑफिस का ईमेल सर्वर, आपका SSL CA) नहीं जानता कि `.eth` का क्या मतलब है और वह इसे रिज़ॉल्व नहीं करेगा।
...
टोकनाइज़ेशन के क्षेत्र में उपलब्ध प्लेटफॉर्म्स के बारे में जानने के लिए, [डोमेन टोकनाइज़ेशन प्लेटफ़ॉर्म कैसे चुनें (Choosing a Domain Tokenization Platform)](/hi/blog/choosing-a-domain-tokenization-platform/) देखें।