...
- **Sie kontrollieren die Domain bei ihrem aktuellen [Registrar](/de/glossary/registrar/).** Sie können sich einloggen, [Nameserver](/de/glossary/nameserver/) ändern und Transfers / [Auth-Codes](/de/glossary/auth-code/) genehmigen.
...
Suchen oder fügen Sie in Ihrem Namefi-Dashboard die Domain hinzu, die Sie bereits besitzen. Namefi prüft die Eignung – den Registrar, bei dem sie sich derzeit befindet, ob sie gesperrt werden kann, ob sie den [ICANN](/de/glossary/icann/)-Transferregeln entspricht und ob die [TLD](/de/glossary/tld/) unterstützt wird.
...
Für den Transfer-Pfad holen Sie sich den **Auth-Code** (manchmal auch EPP-Code genannt) von Ihrem aktuellen Registrar und fügen ihn bei Namefi ein. Möglicherweise müssen Sie auch:
...
Sobald sich die Domain unter der Namefi-Registrar-Integration befindet, werden Sie aufgefordert, die [NFT](/de/glossary/nft/)-Darstellung (ein Standard-[ERC-721](/de/glossary/erc-721/)-Token) zu **minten**. Ihre Wallet öffnet sich; Sie bestätigen eine Transaktion; Gas wird bezahlt; der Token landet in Ihrer Wallet.
...
- Einen On-Chain-NFT in Ihrer Wallet, der das Eigentum repräsentiert.
