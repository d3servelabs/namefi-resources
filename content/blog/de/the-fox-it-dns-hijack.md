...
Hier ist die unbequeme Wahrheit, die dieser Fall greifbar macht: Egal wie gut die interne [Sicherheit](/de/glossary/collateral/) ist, ein großer Teil der Angriffsfläche liegt bei einem Unternehmen, das man selbst nicht betreibt.

Ihre Domain — der Name, den Ihre Kunden eingeben, die Adresse, für die Ihre Zertifikate ausgestellt werden, das Ziel, auf das Ihre E-Mail verweist — wird bei einem Domain-[Registrar](/de/glossary/registrar/) konfiguriert. Wer das Registrar-Konto kontrolliert, bestimmt, wohin der Name aufgelöst wird. Derjenige kann Ihre Website umleiten, Ihre E-Mail umrouten und gegenüber einer Zertifizierungsstelle den „Nachweis der Inhaberschaft" über Ihre Domain erbringen. Dazu ist es nicht nötig, Ihre Server, Ihre Firewalls oder Ihren Code anzufassen. Es reicht, sich in ein Web-Panel einzuloggen.
