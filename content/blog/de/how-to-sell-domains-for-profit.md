...
Seriöse Verkäufer nutzen beides. Inbound fängt die Käufer ab, die bereits wissen, dass sie den Namen wollen; Outbound schafft eine Nachfrage, die von allein nie entstanden wäre. Wir vergleichen die beiden Ansätze ausführlich in [Inbound vs. Outbound Domain-Verkauf](/en/blog/inbound-vs-outbound-domain-sales/).
...
- **Auktionen.** Bei Namen mit konkurrierendem Interesse kann ein [Auktionsformat](/en/glossary/auction/) den Preis über jede feste Zahl hinaus treiben, die Sie sich getraut hätten festzulegen.

Jeder Verkaufsort bietet einen anderen Kompromiss zwischen Reichweite, Gebühren und Kontrolle. Wir stellen die großen Anbieter nebeneinander in [Wo man Domains verkauft: ein Vergleich der Marktplätze](/en/blog/where-to-sell-domains-marketplaces-compared/). Wo auch immer Sie listen, das Listing existiert in der breiteren [Marktplatzebene](/en/glossary/marketplace/) des [Domainhandels](/en/glossary/domain-trading/), und dieselben Grundlagen aus [wie man einen Domainnamen bewertet](/en/blog/how-to-value-a-domain-name/) entscheiden darüber, ob jemand anbeißt.
