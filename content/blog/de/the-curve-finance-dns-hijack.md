...
4. **Haben Sie einen sauberen Fallback.** Curves Rettung war `curve.exchange` auf separater Infrastruktur. Ein zweiter Frontend-Pfad — eine andere Domain, ein anderer DNS-Anbieter, ein IPFS- oder ENS-basierter Spiegel — gibt Ihnen einen Ort, an den Sie Nutzer schicken können, wenn Ihr primärer Name vergiftet ist.
