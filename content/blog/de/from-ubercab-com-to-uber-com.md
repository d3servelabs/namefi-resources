---
title: 'Von UberCab.com zu Uber.com: Wie das Weglassen eines Wortes – und der Tausch von 2 % gegen eine Domain – ein Verb erschuf'
date: '2026-06-16'
language: de
...
![Farbenfrohes Bild eines Domain-gegen-Eigenkapital-Tauschs zwischen Universal Music Group und Uber, bei dem 2 Prozent Eigenkapital gegen die Domain Uber.com getauscht werden](../../assets/from-ubercab-com-to-uber-com-02-equity-trade.jpg)
...
![Farbenfrohes Bild, wie UberCab das Wort „Cab" und ein gelbes Taxi fallen lässt, um zur klaren schwarzen Uber-Marke zu werden](../../assets/from-ubercab-com-to-uber-com-01-dropping-cab.jpg)
...
![Farbenfrohes Bild der Domain uber.com, die durch einen verifizierten Transfer, ein grünes Namefi-Token und DNS-Kontinuität fließt](../../assets/from-ubercab-com-to-uber-com-03-namefi-angle.jpg)
...
[Namefi](https://namefi.io) ist auf der Idee aufgebaut, dass Domains sich wie internet-native Vermögenswerte verhalten sollten. Tokenisiertes Eigentum kann die Kontrolle über Domains leichter verifizierbar, übertragbar und in moderne Workflows integrierbar machen, während es mit [DNS](/de/glossary/dns/) kompatibel bleibt – und damit die chaotischsten Teile eines solchen Deals (beweisen, wer was besitzt, sich auf einen Wert einigen und es sicher übertragen) in etwas verwandelt, das einer sauberen, prüfbaren Transaktion näherkommt. Eine Zukunft, in der eine Domain bewertet, gehandelt und sogar teilweise gegen andere Vermögenswerte getauscht werden kann, ohne einen jahrelangen Papierpfad – genau das ist die Art von Reibung, die dieser Fall mit so viel Aufwand zu überwinden versuchte.
