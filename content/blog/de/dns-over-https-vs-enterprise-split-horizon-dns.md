...
Während der meisten Zeit in der Geschichte des Internets wurden DNS-Anfragen im Klartext über Port 53 übertragen. Jeder auf dem Netzwerkpfad konnte sie mitlesen, protokollieren und verändern. Das war ein Datenschutzproblem, das die IETF schließlich mit zwei verschlüsselten Alternativen anging: [DNS over TLS (DoT, RFC 7858)](https://datatracker.ietf.org/doc/html/rfc7858) im Jahr 2016 und [DNS over HTTPS (DoH, RFC 8484)](https://datatracker.ietf.org/doc/html/rfc8484) im Jahr 2018.
