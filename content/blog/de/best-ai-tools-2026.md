...
GoDaddys Airo-Erlebnis beginnt mit der KI-gestützten Suche nach Domains und Geschäftsnamen; nach der Registrierung einer neuen Domain kann Airo Logo-Optionen und eine anpassbare Coming-soon-Seite erzeugen. [GoDaddy zufolge ist dieser Kernumfang bei der Registrierung einer neuen Domain ohne Aufpreis enthalten, eine vollständige Website, professionelle E-Mail und einige Marketingfunktionen erfordern jedoch kostenpflichtige Produkte oder Upgrades](https://www.godaddy.com/resources/news/what-is-godaddy-airo#how-much-does-godaddy-airo-cost). Die Abhängigkeit von einem durch den Nutzer abgeschlossenen Domainkauf markiert die Stufe: Den Kauf schließen Sie selbst über den normalen Checkout von GoDaddy ab. Es ist eine starke Option für Kleinunternehmer, die zum ersten Mal eine Domain kaufen und Name, Logo und eine Starter-Seite in einer Sitzung möchten, sofern sie prüfen, welche Extras einen separaten Tarif erfordern.
...
| 6 | Cloudflare Registrar API | 3 — Agentische Plattform | Registrierungs-Beta zu Selbstkosten; DNS-Einträge werden über Cloudflares separate DNS-API verwaltet, die auch über den MCP-Server für die Cloudflare API verfügbar ist; keine Kryptozahlung. |
...
Sie sind verwandt, aber nicht identisch. Airo ist das ursprüngliche KI-Angebot für Namensvorschläge, Logo-Optionen und eine Coming-soon-Seite; der Kernumfang ist bei der Registrierung einer neuen Domain ohne Aufpreis enthalten, während eine vollständige Website, professionelle E-Mail und einige Marketingfunktionen kostenpflichtige Produkte oder Upgrades erfordern. Airo.ai, gestartet im November 2025, ist eine neuere und breitere Ebene zur Agentenorchestrierung auf diesem Angebot. Sie kann mehrere TLDs prüfen und eine Domain mit weniger manuellen Wiederholungssuchen reservieren, doch der Schritt der Domainregistrierung erfordert weiterhin die Genehmigung des Nutzers.
...
Namensfindung und Suche lassen sich bei allen vier hier besprochenen Werkzeugen der Stufe 1 kostenlos starten, doch nicht jeder gebündelte Dienst ist kostenlos. GoDaddy zufolge ist der Kernumfang von Airo bei der Registrierung einer neuen Domain ohne Aufpreis enthalten, während eine vollständige Website, professionelle E-Mail und einige Marketingfunktionen kostenpflichtige Produkte oder Upgrades erfordern. Die Domainregistrierung selbst ist weiterhin kostenpflichtig. Zudem kann ein kurzer, einprägsamer Vorschlag eines beliebigen Generators bei einer [Premium-Domain](/de/glossary/premium-domain/) landen, deren Preis deutlich über einer Standardregistrierung liegt; prüfen Sie daher den Preis, bevor Sie sich an einen Namen binden. Unter den Plattformen der Stufe 3 ist Cloudflare der einzige Anbieter mit einer veröffentlichten Zusage für Preise zu Kosten ohne Aufschlag. Name.com und Namefi veröffentlichen keine gleichwertige Richtlinie; prüfen Sie daher die Live-Preise direkt, statt Gleichheit anzunehmen.
...
- GoDaddy — [Was ist GoDaddy Airo?](https://www.godaddy.com/resources/news/what-is-godaddy-airo) — erklärt, dass Airo kostenlos gestartet werden kann, der Kernumfang in der Registrierung einer neuen Domain enthalten ist und eine vollständige Website, professionelle E-Mail sowie einige Marketingfunktionen kostenpflichtige Produkte oder Upgrades erfordern.
...
- Cloudflare — [Registrar-Übersicht und Selbstkostenrichtlinie](https://developers.cloudflare.com/registrar/), [Registrar API Beta](https://developers.cloudflare.com/registrar/registrar-api/), [DNS Records API](https://developers.cloudflare.com/api/resources/dns/subresources/records/) und [Cloudflare API MCP Server](https://developers.cloudflare.com/agents/model-context-protocol/cloudflare/servers-for-cloudflare/#cloudflare-api-mcp-server) — trennt Registrierungsvorgänge von der Verwaltung der DNS-Einträge und bestätigt, dass der API-MCP-Server die Cloudflare API einschließlich DNS abdeckt.
