---
title: 'Psychologie der Domain-Preisgestaltung: Sofortkauf vs. Preisvorschlag'
date: '2026-06-21'
language: de
...
Beginnen wir mit der einen kognitiven Verzerrung, die jede Preisverhandlung beherrscht. Der Verankerungseffekt ist, wie Wikipedia ihn definiert, [ein psychologisches Phänomen, bei dem die Urteile oder Entscheidungen einer Person von einem Referenzpunkt oder „Anker“ beeinflusst werden](https://en.wikipedia.org/wiki/Anchoring_effect#:~:text=a%20psychological%20phenomenon%20in%20which%20an%20individual%27s%20judgments%20or%20decisions%20are%20influenced%20by%20a%20reference%20point), und dieser Referenzpunkt kann fast willkürlich sein. Sobald eine Zahl auf dem Tisch liegt, wird jede folgende Zahl daran gemessen. Der Käufer, der zuerst „$25,000“ hört, wird $12,000 als Erfolg werten; der Käufer, der zuerst „$3,000“ hört, wird $4,500 als große Anstrengung betrachten. Derselbe Name, derselbe Käufer, anderer Anker, andere Obergrenze.

Das ist keine Folklore. Wie derselbe Artikel feststellt, [haben Erstangebote einen stärkeren Einfluss auf das Ergebnis von Verhandlungen als nachfolgende Gegenangebote](https://en.wikipedia.org/wiki/Anchoring_effect#:~:text=initial%20offers%20have%20a%20stronger%20influence%20on%20the%20outcome%20of%20negotiations%20than%20subsequent%20counteroffers). Wer den Anker setzt, lenkt das Gespräch in seine Richtung. Für einen Verkäufer erklärt diese eine Erkenntnis die meisten der folgenden Taktiken: Ein Preis ist nicht nur eine Information, er ist der Gravitationsbrunnen, in den die Verhandlung fällt.
...
Nennen Sie einen zu niedrigen Preis, und Sie haben den Anker *gegen sich selbst* gesetzt. Das können Sie nicht mehr rückgängig machen: Der Käufer weiß nun, dass Ihre Untergrenze unter seinem Budget lag, und kein noch so oft erwähntes „es gibt andere Interessenten“ macht das wieder wett. Viele Flipper haben $1,500 für einen Namen verlangt, für den ein [Endnutzer](/de/glossary/end-user/) gerne $15,000 bezahlt hätte, weil sie den Preis so gestaltet haben, als würde ein anderer Investor Inventar auf dem [Domain-Handelsmarkt](/de/glossary/domain-trading/) kaufen, und nicht ein Unternehmen, das ein Werkzeug erwirbt. Diese Lücke zwischen Wiederverkäufer- und Endnutzerpreis ist der teuerste Fehler, den man machen kann, und wir erläutern ihn in [wie man einen Domain-Namen bewertet](/de/blog/how-to-value-a-domain-name/) und [eingehende vs. ausgehende Domain-Verkäufe](/de/blog/inbound-vs-outbound-domain-sales/).
...
Bevor wir zu den Taktiken kommen, eine Warnung bezüglich Ihrer eigenen Denkweise. Domain-Händler bewerten die Namen in ihrem Besitz systematisch zu hoch, und dafür gibt es einen Begriff. Der Besitztumseffekt ist die Erkenntnis, dass [Menschen eher ein Objekt behalten, das sie besitzen, als dasselbe Objekt zu erwerben, wenn sie es nicht besitzen](https://en.wikipedia.org/wiki/Endowment_effect#:~:text=people%20are%20more%20likely%20to%20retain%20an%20object%20they%20own): Der Besitz selbst bläht den wahrgenommenen Wert auf. Sie haben den Namen gekauft, weil Sie etwas darin gesehen haben, und dieselbe Überzeugung ist nun eine Belastung für Ihr Urteilsvermögen.
...
Auch die Form der Zahl sendet eine eigene Botschaft. Dies ist das Gebiet der psychologischen Preisgestaltung, die Wikipedia als eine Strategie beschreibt, die [auf der Theorie basiert, dass bestimmte Preise eine psychologische Wirkung haben](https://en.wikipedia.org/wiki/Psychological_pricing#:~:text=based%20on%20the%20theory%20that%20certain%20prices%20have%20a%20psychological%20impact). Die klassische Erkenntnis ist, dass Käufer [Preise knapp unter einer runden Zahl (auch als „ungerade Preise“ bezeichnet) als niedriger wahrnehmen, als sie tatsächlich sind](https://en.wikipedia.org/wiki/Psychological_pricing#:~:text=just%2Dbelow%20prices%20%28also%20referred%20to%20as%20%22odd%20prices%22%29%20as%20being%20lower%20than%20they%20are) – der Grund, warum der Einzelhandel auf $9.99 setzt, angetrieben von dem, was Forscher den [Left-Digit-Effekt](https://en.wikipedia.org/wiki/Psychological_pricing#:~:text=left%2Ddigit%20effect) nannten.
...
- Wikipedia – [Anchoring effect (Verankerungseffekt)](https://en.wikipedia.org/wiki/Anchoring_effect#:~:text=a%20psychological%20phenomenon%20in%20which%20an%20individual%27s%20judgments%20or%20decisions%20are%20influenced%20by%20a%20reference%20point) (Definition; Erstangebote wiegen schwerer als spätere Gegenangebote)
- Wikipedia – [Endowment effect (Besitztumseffekt)](https://en.wikipedia.org/wiki/Endowment_effect#:~:text=people%20are%20more%20likely%20to%20retain%20an%20object%20they%20own) (Besitz erhöht den wahrgenommenen Wert)
- Wikipedia – [Psychological pricing (Psychologische Preisgestaltung)](https://en.wikipedia.org/wiki/Psychological_pricing#:~:text=based%20on%20the%20theory%20that%20certain%20prices%20have%20a%20psychological%20impact) (psychologische Preise, Schwellenpreise, der Left-Digit-Effekt)