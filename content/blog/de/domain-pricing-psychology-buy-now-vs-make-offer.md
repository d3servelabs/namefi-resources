...
Die Domain-Endung spielt ebenfalls eine Rolle: Dasselbe Wort unter einer [`.com`](/en/tld/com/) hat eine andere Preisobergrenze als unter [`.io`](/en/tld/io/) oder [`.co`](/en/tld/co/), also passen Sie die Form dem Namen und dem Käufer an. Ein runder Premium-Preis filtert nach Endnutzern; ein psychologischer Preis filtert nach Schnäppchenjägern und anderen Wiederverkäufern auf dem [Marktplatz](/en/glossary/marketplace/). Eine Nichtübereinstimmung schreckt leise den Käufer ab, den Sie eigentlich wollen.
