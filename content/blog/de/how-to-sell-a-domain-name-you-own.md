---
title: "Wie man einen eigenen Domainnamen verkauft: Eine praktische Checkliste"
date: '2026-06-09'
language: de
...
| --- | --- |
| [Vergleichbare Verkäufe](/de/glossary/comparable-sales/) | Jüngste Verkäufe mit ähnlicher Länge, Wortzahl, Kategorie und TLD |
...
| Ihre Einschränkungen | Verlängerungskosten, Dringlichkeit, akzeptabler [Mindestpreis](/de/glossary/reserve-price/) und Geduld |
...
- **Festpreis / [Sofortkauf](/de/glossary/buy-it-now/):** am besten, wenn Sie Geschwindigkeit und weniger Hin-und-Her wollen.
...
[Namefi Outbound](https://namefi.io/outbound) wurde speziell für den Rechercheteil des Prozesses entwickelt.
...
Wenn Sie kommerzielle E-Mails versenden, befolgen Sie die für Sie geltenden Regeln. In den USA deckt der [CAN-SPAM-Leitfaden der FTC](https://www.ftc.gov/business-guidance/resources/can-spam-act-compliance-guide-business) Anforderungen wie korrekte Absenderinformationen, nicht-irreführende Betreffzeilen, eine gültige Postanschrift und ein klares Opt-out ab. Andere Länder können noch strenger sein. „Ich verkaufe doch nur eine Domain“ ist keine Compliance-Strategie.
...
- Wer die Gebühren für Treuhand (Escrow), [Marktplatz](/de/glossary/marketplace/), Transfer oder Zahlung übernimmt.
...
Hüten Sie sich vor Betrug. Die [FTC](https://consumer.ftc.gov/articles/how-avoid-scam) warnt davor, dass Betrüger oft Druck auf Menschen ausüben, sofort zu handeln, auf bestimmten Zahlungsmethoden bestehen oder Schecks senden, die sich später als Fälschung herausstellen. Für Domainverkäufer sind die üblichen Muster bekannt:
...
In den USA behandelt die IRS den Verkauf von Vermögenswerten nach Steuervorschriften, die davon abhängen, wie der Vermögenswert gehalten und genutzt wurde; die [IRS-Publikation 544](https://www.irs.gov/publications/p544) ist hierfür ein Ausgangspunkt, aber kein Ersatz für einen Steuerberater (CPA). Andere Rechtsordnungen haben ihre eigenen Regeln.
...
Wenn Sie bereit sind, mögliche Käufer für eine Domain zu recherchieren, die Sie besitzen oder vertreten, starten Sie mit [Namefi Outbound](https://namefi.io/outbound).