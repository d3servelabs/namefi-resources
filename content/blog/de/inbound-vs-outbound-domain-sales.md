...
- **Hohe Marge.** Ein Käufer, der von sich aus kommt, ist in der Regel ein [Endnutzer](/de/glossary/end-user/), der den Namen bereits will. Das bedeutet, er ist bereit, einen Endnutzerpreis zu zahlen anstatt den Großhandelspreis eines Wiederverkäufers. Die [Preisspanne zwischen Endnutzer und Wiederverkäufer](/de/blog/end-user-vs-reseller-domain-pricing/) ist der alleinige Grund, warum Inbound so profitabel sein kann.
