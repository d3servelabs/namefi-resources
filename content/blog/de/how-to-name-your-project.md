---
title: "Wie Sie Ihr Projekt benennen: Ein Praxisleitfaden für Gründer"
date: '2026-06-13'
language: de
...
![Redaktionelles Flat-Lay zur Namens-Due-Diligence: ein Markenrechercheergebnis, eine Domain-Verfügbarkeitskarte und eine Lupe über einer Auswahlliste](../../assets/how-to-name-your-project-01-clear-the-name.jpg)

### In Ihrer Kategorie einzigartig sein

Der relevante rechtliche Test ist nicht „Gibt es diesen Namen irgendwo auf der Erde bereits?" Entscheidend ist die **Verwechslungsgefahr**: Würde ein durchschnittlicher Käufer, der Ihre Marke in Ihrer Kategorie sieht, plausiblerweise glauben, sie stamme von jemand anderem? US-amerikanische Prüfer und Gerichte wägen dabei eine Reihe von Faktoren ab – vor allem die Ähnlichkeit der Zeichen in Klang, Erscheinung und Bedeutung sowie die Verwandtschaft der Waren oder Dienstleistungen – bekannt als die [DuPont-Faktoren](https://www.uspto.gov/page/about-trademark-infringement). Zwei identische Namen können in nicht verwandten Kategorien nebeneinander existieren (Dove-Seife und Dove-Schokolade); zwei *ähnliche* Namen in *derselben* Kategorie sind jedoch ein Problem, selbst wenn sie nicht identisch sind.
...
- **Markendatenbanken.** Suchen Sie im [USPTO-Markensuchsystem](https://www.uspto.gov/trademarks/search) für die USA, in der [EUIPO-Datenbank](https://www.euipo.europa.eu/en/trade-marks/before-applying) für die EU und in der [WIPO Global Brand Database](https://branddb.wipo.int/) für eine internationale Übersicht. Sie machen keine anwaltliche Recherche – Sie suchen nach offensichtlichen Konflikten, kostenlos.
- **Domains.** Die `.com`-Domain verankert für die meisten Unternehmen die Glaubwürdigkeit. Auf [Namefi](https://namefi.io) können Sie die Verfügbarkeit prüfen, sehen, **wie lange eine `.com`-Domain bereits registriert ist** (ein Name, der seit 2009 kontinuierlich gehalten wird, ist ein ganz anderes Signal als einer, der letzten Monat registriert wurde), und **wie viele TLDs unter diesem Namen bereits registriert sind**. Ein Name, der auf 30 Endungen belegt ist, ist umkämpftes Terrain; ein Name, der fast überall frei ist, ist freie Fahrt. Nutzen Sie diese Verteilung als schnellen Gradmesser dafür, wie belegt dieses Wort ist.
- **Handles.** Prüfen Sie die [GitHub](https://github.com)-Organisation sowie X, Reddit, LinkedIn und die Plattformen, auf denen Ihre Nutzer tatsächlich aktiv sind. Einheitliche Handles im gesamten Web sind für ein junges Projekt überraschend wertvoll – und sie werden nach dem Prinzip „Wer zuerst kommt" vergeben.
...
![Redaktionelle Illustration des Namensbaus: Wort-Kacheln, die zu Komposita kombiniert werden, Präfixe und Suffixe sowie spielerische Falschschreibungen](../../assets/how-to-name-your-project-03-build-candidates.jpg)
...
- **Präfixe & Suffixe** — hängen Sie `-ly`, `-ify`, `-io`, `-ai`, `-hq` an: *Spotify*, *Shopify*, *Calendly*.
- **Falschschreibungen** — verbiegen Sie ein bekanntes Wort, damit die Domain besitzbar wird: *Flickr*, *Tumblr*, *Lyft* und *Google* selbst (von „Googol").
...
![Redaktionelle Illustration eines abstrakten Namensworts, das sich in eine einfache ikonische Logo-Form auflöst, z. B. ein Blatt oder ein Pfeil](../../assets/how-to-name-your-project-04-make-it-concrete.jpg)
...
![Redaktionelle Illustration einer Namenskarte, die gegen mehrere Sprachen und Schriften auf einer Weltkarte geprüft wird, wobei eine wegen einer schlechten Bedeutung markiert ist](../../assets/how-to-name-your-project-05-travel-test.jpg)
...
1. **Websuche** — ist die erste Seite frei von Wettbewerbern?
2. **Marken** — [USPTO](https://www.uspto.gov/trademarks/search), [EUIPO](https://www.euipo.europa.eu/en/trade-marks/before-applying) und [WIPO Global Brand Database](https://branddb.wipo.int/) für Ihre Kategorie.
3. **Domain** — ist die `.com` verfügbar oder erwerbbar? Prüfen Sie auf [Namefi](https://namefi.io) das **Registrierungsalter der `.com`** und die **Anzahl der bereits registrierten TLDs**, um einzuschätzen, wie umkämpft der Name ist.
4. **GitHub** — ist die Organisation/das Handle frei? (Entscheidend für alles, was an Entwickler gerichtet ist.)
5. **Social-Handles** — X, Reddit, LinkedIn, Instagram, YouTube – was auch immer für Ihre Zielgruppe wichtig ist, idealerweise alles übereinstimmend.
6. **App-Stores**, wenn Sie eine App veröffentlichen werden.
...
- USPTO — [Über Markenverletzungen (Verwechslungsgefahr & DuPont-Faktoren)](https://www.uspto.gov/page/about-trademark-infringement) · Nolo — [Verwechslungsgefahr, erklärt](https://www.nolo.com/legal-encyclopedia/likelihood-confusion-how-do-you-determine-trademark-infringing.html)
- Markensuchtools — [USPTO](https://www.uspto.gov/trademarks/search) · [EUIPO](https://www.euipo.europa.eu/en/trade-marks/before-applying) · [WIPO Global Brand Database](https://branddb.wipo.int/) · [TMview (global)](https://www.tmdn.org/tmview/)
- Alter, A. L., & Oppenheimer, D. M. (2006). [Predicting short-term stock fluctuations by using processing fluency](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC1482615/) (frei zugänglicher Volltext). *PNAS*, 103(24).
...
- Laham, S. M., Koval, P., & Alter, A. L. (2012). [The name-pronunciation effect: Why people like Mr. Smith more than Mr. Colquhoun](https://ppw.kuleuven.be/okp/_pdf/Laham2012TNPEW.pdf) (Volltext-PDF). *Journal of Experimental Social Psychology*, 48(3). Leicht verständliche [NYU Stern-Zusammenfassung](https://www.stern.nyu.edu/experience-stern/faculty-research/adam-alter-names-study).
- Yorkston, E., & Menon, G. (2004). [A Sound Idea: Phonetic Effects of Brand Names on Consumer Judgments](https://pages.stern.nyu.edu/~gmenon/A%20Sound%20Idea.pdf) (Volltext-PDF). *Journal of Consumer Research*, 31(1).
- Topolinski, S., Zürn, M., & Schneider, I. K. (2015). [What's in and what's out in branding? A novel articulation effect for brand names](https://pmc.ncbi.nlm.nih.gov/articles/PMC4429570/) (Open Access). *Frontiers in Psychology*, 6.
- Snopes — [Did the Chevrolet Nova Fail to Sell in Spanish-Speaking Countries?](https://www.snopes.com/fact-check/chevrolet-nova-name-spanish/) (Widerlegung des Mythos)
- Wikipedia — [Mitsubishi Pajero / Montero-Umbenennung](https://en.wikipedia.org/wiki/Mitsubishi_Pajero) (eine reale Lokalisierungsumbenennung)
