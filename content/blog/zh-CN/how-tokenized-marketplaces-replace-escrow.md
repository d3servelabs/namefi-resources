...
2. 进行价格谈判。
3. 在 [Escrow.com](https://www.escrow.com/) 或类似平台开启[第三方托管（Escrow）](/zh-CN/glossary/escrow/)。买方电汇资金。
4. 卖方解锁域名并提供[授权码（Auth Code）](/zh-CN/glossary/auth-code/)。
5. 买方在其[注册商](/zh-CN/glossary/registrar/)处发起[跨注册商转移](/zh-CN/glossary/cross-registrar-transfer/)。
6. 等待 5–7 天以完成 [ICANN](/zh-CN/glossary/icann/) 的转移流程。
7. 确认转移；托管方释放资金。
...
1. 在[交易市场](/zh-CN/glossary/marketplace/)（如 Namefi 官方市场、Doma、[OpenSea](https://opensea.io/)、[Blur](https://blur.io/) 等）上架[代币化域名](/zh-CN/blog/what-are-tokenized-domains/)。
2. 买方付款。[NFT](/zh-CN/glossary/nft/) 转移到买方的[钱包](/zh-CN/glossary/wallet/)。平台会自动保持[注册商](/zh-CN/glossary/registrar/)端的记录同步。
3. 完成。

就是这样。仅仅两步。没有[授权码](/zh-CN/glossary/auth-code/)，没有[托管](/zh-CN/glossary/escrow/)，没有 5 天的注册商锁定限制，也没有“我钱打过去了，现在只能相信你了”的信任空档期。

这之所以可行，是因为 **NFT 是所有权的权威记录**，而且[链上](/zh-CN/glossary/on-chain/)交易是[原子化](/zh-CN/glossary/atomic-transfer/)的：付款和资产转移在同一个区块内同时发生，要么同时成功，要么双双失效。
...
与传统域名世界中 Sedo 和 Afternic 运营的“封闭式花园”相比，这是[流动性](/zh-CN/glossary/domain-liquidity/)方面一次意义重大的飞跃。
...
**被加密货币和[稳定币](/zh-CN/glossary/stablecoin/)支付所取代。** USDC、ETH 以及其他链上支付能在几秒钟内完成结算。而电汇则需要数天时间。这种差异在跨国交易中尤为明显。
...
交易市场的[智能合约](/zh-CN/glossary/smart-contract/)成了新的“第三方托管”。如果它存在漏洞，可能会发生难以预料的问题。这就是为什么经过审计和实战检验的市场如此重要。对于高价值的销售，不要成为全新智能合约的首个“小白鼠”。
...
在某些司法管辖区，以加密货币支付的销售与以法定货币支付的销售属于不同的税务事件。请参阅[代币化域名的税务与会计问题文章](/zh-CN/blog/tax-and-accounting-questions-for-tokenized-domains/)，了解您可以向注册会计师（CPA）咨询的问题清单。
...
- **费用更低。** 没有托管费抽成。平台费和 [Gas](/zh-CN/glossary/gas/) 费通常远低于 3–6%。
...
- 针对异质资产的估值工具需要改进。
- 代币化平台需覆盖更广泛的[顶级域名](/zh-CN/glossary/tld/)（TLD）。
...
如果您想亲自尝试出售代币化域名，请访问 [namefi.io](https://namefi.io)。如需了解更宏观的行业图景，请参阅[《2026 年代币化域名的应用用例》](/zh-CN/blog/tokenized-domain-use-cases-2026/)。