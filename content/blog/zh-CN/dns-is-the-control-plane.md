...
每一个应用程序和网站都需要一种方式来“查找”连接地址。这个互联网的地址簿被称为 [DNS](/zh-CN/glossary/dns/)（域名系统，Domain Name System）。10月20日，AWS 内部的一个命名问题导致部分计算机无法通过名称找到关键的 AWS 数据库服务。如果地址簿不能在关键时刻提供正确的条目，即使是健康的系统也无法相互通信。
