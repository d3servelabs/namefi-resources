...
root: false
description: >-
  Trigger when agent is planning or coding on UI labels, copywriting, email
  templates, UI modals, dialogs, error messages, success messages,
  notifications, tooltips, or any user-facing messaging.
globs: []
cursor:
  alwaysApply: false
  description: >-
