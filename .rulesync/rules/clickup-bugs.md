...
root: false
description: >-
  Trigger when the user asks to file a bug report or create a ClickUp task for a
  bug/issue.
globs: []
cursor:
  alwaysApply: false
  description: >-
    Trigger when the user asks to file a bug report or create a ClickUp task for
    a bug/issue.
---
