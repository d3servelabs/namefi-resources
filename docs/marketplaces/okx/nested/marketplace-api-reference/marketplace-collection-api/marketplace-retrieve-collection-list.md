...
|---------------|----------|--------------|----------------------------------------------------------------------------------------------------------|
| chain         | String   | No           | Chain name refer to [Supported blockchains](../../linked-resources/marketplace-supported-blockchains.md) for details                               |
...
Array of objects of the [collection model](../marketplace-models/marketplace-collection-model.md#collection-model)
...
| assetContracts  | Array    | An array of the [asset contract model](../marketplace-models/marketplace-collection-model.md#asset-contract-model) that are associated with this collection, including contract address, protocol standard, owner address, whether the ERC-2981 protocol is supported, etc. |
| stats           | Object   | A dictionary containing some statistics related to this collection, including trade volume and floor prices, an object of the [collection stats model](../marketplace-models/marketplace-collection-model.md#collection-stats-model)                                        |
