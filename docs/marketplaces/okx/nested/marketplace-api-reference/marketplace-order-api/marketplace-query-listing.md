...
| platform          | String   | No           | For supported platform, refer to [Integrated markets](../../linked-resources/marketplace-integrated-markets.md)                                                                                                                    |
...
An array of [OKX order model](../marketplace-models/marketplace-order-model.md#okx-order-model)
