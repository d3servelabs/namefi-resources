...
|-----------------|----------|--------------|---------------------------------------------------------------------------|
| chain | Yes | String | Chain name refer to [Supported blockchains](../../linked-resources/marketplace-supported-blockchains.md) for details. |
| collectionAddress |Yes | String | The unique collection address of the transaction history to query for. |
| platform | No | String | For supported platforms, refer to [Integrated markets](../../linked-resources/marketplace-integrated-markets.md). If this is empty, it will query all platforms. |
...
| chain | String | Chain name refer to [Supported blockchains](../../linked-resources/marketplace-supported-blockchains.md) for details. |
...
| to | String | The buyer. |
| platform | String | For supported platforms, refer to [Integrated markets](../../linked-resources/marketplace-integrated-markets.md). |
