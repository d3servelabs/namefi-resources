...
This API is used to list a single Runes inscription on the OKX platform. Before listing, you can [get wallet assets](./marketplace-runes-asset.md) (get the holding information of a specific token in the wallet) to first get the list of Runes inscriptions you hold.
