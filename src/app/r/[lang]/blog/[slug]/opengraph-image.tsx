...
function Logotype({ fill = '#1CD17D' }: { fill?: string }) {
  return (
    // biome-ignore lint/a11y/noSvgWithoutTitle: this is procedural image
    <svg
      width={240}
      height={(240 / 132) * 43}
      viewBox="0 0 132 43"
