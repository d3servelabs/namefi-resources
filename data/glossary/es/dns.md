...
El **DNS (Sistema de Nombres de Dominio)** es la guía telefónica de internet —un sistema jerárquico que traduce nombres de dominio legibles por humanos como `google.com` en direcciones IP que las computadoras utilizan para localizar servidores. El DNS es gestionado por una red global de servidores y gobernado por [ICANN](/r/es/glossary/icann/) a través de registros y [registradores](/r/es/glossary/registrar/). Cuando Namefi tokeniza un dominio, la funcionalidad DNS subyacente permanece intacta, pero la propiedad y la gestión se descentralizan. El [NFT](/r/es/glossary/nft/) de dominio tokenizado representa los derechos de propiedad del nombre DNS, permitiendo transferencias y gestión basadas en blockchain mientras el dominio continúa resolviéndose normalmente en internet a través de la infraestructura DNS tradicional.