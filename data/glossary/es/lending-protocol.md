...
Un **protocolo de préstamo** es una plataforma de finanzas descentralizadas (DeFi) que permite a los usuarios prestar y pedir prestado activos de criptomonedas sin intermediarios tradicionales como los bancos. Estos protocolos utilizan [contratos inteligentes](/r/es/glossary/smart-contract/) para automatizar los términos de los préstamos, las tasas de interés y la gestión del [colateral](/r/es/glossary/collateral/). Ejemplos populares incluyen Aave, Compound y MakerDAO. Los dominios tokenizados pueden participar en protocolos de préstamo como [colateral](/r/es/glossary/collateral/) —los usuarios pueden bloquear sus valiosos [NFTs](/r/es/glossary/nft/) de dominio para pedir prestado criptomonedas, o ganar rendimiento al proporcionar liquidez. Esto crea nuevas oportunidades financieras para los poseedores de dominios, permitiéndoles acceder a capital sin vender sus dominios o generar ingresos pasivos de sus propiedades inmobiliarias digitales.